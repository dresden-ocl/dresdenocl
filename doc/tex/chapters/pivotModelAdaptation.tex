...
\reference{org.dresdenocl.codegen.adapter}. The only prerequisites are 
the core features (\reference{org.dresdenocl.feature.core}) of Dresden OCL and
...
\code{org.dresdenocl\linebreak[0].pi\-vot\linebreak[0].meta\-mo\-dels.<meta-model name>}. The package explorer is shown in Figure \ref{pic:pivotModelAdaption:GeneratedPlugin}.
