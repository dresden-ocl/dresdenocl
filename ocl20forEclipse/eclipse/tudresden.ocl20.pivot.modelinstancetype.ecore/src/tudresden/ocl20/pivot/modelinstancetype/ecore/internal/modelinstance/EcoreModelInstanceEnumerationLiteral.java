...
This file is part of the EME Ecore Model Instance Plug-in of Dresden OCL2 for 
Eclipse.
...
/**
 * <p>
 * An adapter {@link Class} for {@link EcoreModelInstanceEnumerationLiteral}s of
 * {@link EcoreModelInstance}s.
 * </p>
 * 
 * @author Claas Wilke
 */
public class EcoreModelInstanceEnumerationLiteral extends
		AbstractModelInstanceElement implements IModelInstanceEnumerationLiteral {

	/** The {@link Logger} for this class. */
	private static final Logger LOGGER =
			EcoreModelInstanceTypePlugin
					.getLogger(EcoreModelInstanceEnumerationLiteral.class);

	/**
	 * <p>
	 * The adapted {@link Enum} of this
	 * {@link EcoreModelInstanceEnumerationLiteral}.
	 * </p>
	 */
	 ...
	 *          {@link EcoreModelInstanceEnumerationLiteral} can only have one
	 *          {@link Type}.</strong>
	 */
	protected EcoreModelInstanceEnumerationLiteral(Enum<?> literal,
			Set<Type> types) {
		...
		if (LOGGER.isDebugEnabled()) {
			...
			msg = "EcoreModelInstanceEnumerationLiteral("; //$NON-NLS-1$
		...
		if (LOGGER.isDebugEnabled()) {
			...
			msg = "EcoreModelInstanceEnumerationLiteral(Enum<?>, "; //$NON-NLS-1$
	...
	public IModelInstanceElement asType(Type type) throws AsTypeCastException {
		...
		if (this.myTypes.contains(type)) {
			...
			result = new EcoreModelInstanceEnumerationLiteral(this.myLiteral, types);
		}
		// no else.
	...
	public IModelInstanceElement copyForAtPre() {
		...
		return new EcoreModelInstanceEnumerationLiteral(this.myLiteral,
