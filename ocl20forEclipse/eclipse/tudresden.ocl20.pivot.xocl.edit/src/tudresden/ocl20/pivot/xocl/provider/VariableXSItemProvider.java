 ...
 * {@link tudresden.ocl20.pivot.xocl.VariableXS} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class VariableXSItemProvider extends ElementXSItemProvider implements
  ...
  /**
   * This returns VariableXS.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage(
        "full/obj16/VariableXS")); //$NON-NLS-1$
  }
   ...
   * 
   * <p>
   * The EMF implementation is adapted to return the name and type of the
   * variable.
   * </p>
   * 
   * @generated NOT
  ...
  public String getText(Object object) {
    ...
    StringBuilder label = new StringBuilder(
        StringUtils.isEmpty(name) ? "unnamed" : name); //$NON-NLS-1$
    ...
    // add init expression if existing
    OclExpressionXS initExpression = variable.getInitExpression();

    if (initExpression != null) {
      label.append(" = ").append(getLabel(initExpression)); //$NON-NLS-1$
    }
   ...
   * 
   * <p>
   * Adapted the EMF implementation to update the whole hierarchy if name, type
   * or init expression of the variable change.
   * </p>
   * 
   * @generated NOT
   */
  ...
  protected void collectNewChildDescriptors(
    ...
    newChildDescriptors.add(createChildParameter(
        XOCLPackage.Literals.VARIABLE_XS__INIT_EXPRESSION,
