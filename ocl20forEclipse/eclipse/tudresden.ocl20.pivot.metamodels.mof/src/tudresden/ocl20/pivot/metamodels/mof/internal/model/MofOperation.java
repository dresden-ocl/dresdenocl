...
public class MofOperation extends AbstractOperation implements Operation {
	...
	public MofOperation(tudresden.ocl20.core.jmi.mof14.model.Operation operation) {
		if (logger.isDebugEnabled()) {
			logger
					.debug("MofOperation(tudresden.ocl20.core.jmi.mof14.model.Operation operation="
							+ operation + ") - enter");
		}
		...
		if (logger.isDebugEnabled()) {
			logger
					.debug("MofOperation(tudresden.ocl20.core.jmi.mof14.model.Operation) - exit");
		}
	}
	...
	public List<Parameter> getOwnedParameter() {
		...
		Iterator<tudresden.ocl20.core.jmi.mof14.model.Parameter> it = 
			operation.getParametersA().iterator();
	...
	public List<Parameter> getInputParameter() {
		...
		Iterator<tudresden.ocl20.core.jmi.mof14.model.Parameter> it = 
			operation.getInParametersA().iterator();
	...
	public List<Parameter> getOutputParameter() {
		...
		Iterator<tudresden.ocl20.core.jmi.mof14.model.Parameter> it = 
			operation.getOutParametersA().iterator();
	...
	public Parameter getReturnParameter() {
		...
		Parameter returnParameter = operation.getReturnParameterA() == null ? null
				: MofAdapterFactory.INSTANCE
						.createParameter((tudresden.ocl20.core.jmi.mof14.model.Parameter) operation
								.getReturnParameterA());
		if (logger.isDebugEnabled()) {
	...
	public Type getOwningType() {
		...
		Type returnType = MofAdapterFactory.INSTANCE
				.createType((Classifier) operation.getContainer());
		if (logger.isDebugEnabled()) {
