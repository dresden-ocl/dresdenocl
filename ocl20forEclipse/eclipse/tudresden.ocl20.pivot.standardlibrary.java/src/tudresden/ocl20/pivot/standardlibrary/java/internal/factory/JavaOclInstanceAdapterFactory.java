...
//
//	/**
//	 * Contains the already adapted {@link IModelInstanceElement}s. <strong>This is a
//	 * {@link WeakHashMap}! Adapted objects whose adaptee does not exist anymore
//	 * can be disposed</strong></p> .
//	 */
//	private Map<IModelInstanceElement, OclRoot> myCachedAdapters =
//			new WeakHashMap<IModelInstanceElement, OclRoot>();
//
//	/**
...
//			for (IModelInstanceElement modelObject : modelInstanceCollection
...
//	 * @see
//	 * tudresden.ocl20.pivot.essentialocl.standardlibrary.IOclInstanceAdapterFactory
//	 * #createOclObject(tudresden.ocl20.pivot.modelbus.IModelInstanceElement)
//	 */
...
//		/* Else create the adapter. */
//		if (result == null) {
//			Object adaptedObject = modelInstanceObject.getObject();
//
//			result =
...
//	 * @see
//	 * tudresden.ocl20.pivot.essentialocl.standardlibrary.IOclInstanceAdapterFactory
//	 * #createOclRoot(tudresden.ocl20.pivot.modelbus.IModelInstanceElement)
//	 */
