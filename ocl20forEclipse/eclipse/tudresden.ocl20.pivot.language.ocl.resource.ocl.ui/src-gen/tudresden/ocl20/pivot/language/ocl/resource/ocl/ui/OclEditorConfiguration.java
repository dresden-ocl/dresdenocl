...
public class OclEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private tudresden.ocl20.pivot.language.ocl.resource.ocl.ui.OclEditor theEditor;
	 ...
	 */
	public OclEditorConfiguration(tudresden.ocl20.pivot.language.ocl.resource.ocl.ui.OclEditor editor, tudresden.ocl20.pivot.language.ocl.resource.ocl.ui.OclColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new tudresden.ocl20.pivot.language.ocl.resource.ocl.ui.OclCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new tudresden.ocl20.pivot.language.ocl.resource.ocl.ui.OclTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new tudresden.ocl20.pivot.language.ocl.resource.ocl.ui.OclHyperlinkDetector(theEditor.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new tudresden.ocl20.pivot.language.ocl.resource.ocl.ui.OclQuickAssistAssistant(theEditor);
		}
