...
public class OclReferenceResolverSwitch implements tudresden.ocl20.pivot.language.ocl.resource.ocl.IOclReferenceResolverSwitch {
	...
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.PackageDeclarationNestedNamespaceCSNamespaceReferenceResolver getPackageDeclarationNestedNamespaceCSNamespaceReferenceResolver() {
		return packageDeclarationNestedNamespaceCSNamespaceReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.AttributeContextDeclarationCSPropertyReferenceResolver getAttributeContextDeclarationCSPropertyReferenceResolver() {
		return attributeContextDeclarationCSPropertyReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OperationDefinitionCSOperationReferenceResolver getOperationDefinitionCSOperationReferenceResolver() {
		return operationDefinitionCSOperationReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.ParameterCSParameterReferenceResolver getParameterCSParameterReferenceResolver() {
		return parameterCSParameterReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OperationCallBaseExpCSOperationNameReferenceResolver getOperationCallBaseExpCSOperationNameReferenceResolver() {
		return operationCallBaseExpCSOperationNameReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.PropertyCallBaseExpCSPropertyReferenceResolver getPropertyCallBaseExpCSPropertyReferenceResolver() {
		return propertyCallBaseExpCSPropertyReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.TypePathNameSimpleCSTypeNameReferenceResolver getTypePathNameSimpleCSTypeNameReferenceResolver() {
		return typePathNameSimpleCSTypeNameReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.TypePathNameNestedCSNamespaceReferenceResolver getTypePathNameNestedCSNamespaceReferenceResolver() {
		return typePathNameNestedCSNamespaceReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.CollectionTypeIdentifierCSTypeNameReferenceResolver getCollectionTypeIdentifierCSTypeNameReferenceResolver() {
		return collectionTypeIdentifierCSTypeNameReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.StaticOperationCallExpCSOperationNameReferenceResolver getStaticOperationCallExpCSOperationNameReferenceResolver() {
		return staticOperationCallExpCSOperationNameReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.EnumLiteralOrStaticPropertyExpCSEnumLiteralOrStaticPropertyReferenceResolver getEnumLiteralOrStaticPropertyExpCSEnumLiteralOrStaticPropertyReferenceResolver() {
		return enumLiteralOrStaticPropertyExpCSEnumLiteralOrStaticPropertyReferenceResolver;
	}
	
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.NamedLiteralExpCSNamedElementReferenceResolver getNamedLiteralExpCSNamedElementReferenceResolver() {
		return namedLiteralExpCSNamedElementReferenceResolver;
	}
