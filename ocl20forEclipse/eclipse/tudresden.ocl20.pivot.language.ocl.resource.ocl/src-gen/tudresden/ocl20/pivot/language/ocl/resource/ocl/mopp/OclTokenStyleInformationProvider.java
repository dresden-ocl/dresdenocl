...
public class OclTokenStyleInformationProvider {
	...
	public tudresden.ocl20.pivot.language.ocl.resource.ocl.IOclTokenStyle getDefaultTokenStyle(String tokenName) {
		...
		if ("BOOLEAN_LITERAL".equals(tokenName)) {
			return new tudresden.ocl20.pivot.language.ocl.resource.ocl.mopp.OclTokenStyle(new int[] {0x80, 0x00, 0x40}, null, true, false, false, false);
		}
		...
		if ("package".equals(tokenName)) {
			return new tudresden.ocl20.pivot.language.ocl.resource.ocl.mopp.OclTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
