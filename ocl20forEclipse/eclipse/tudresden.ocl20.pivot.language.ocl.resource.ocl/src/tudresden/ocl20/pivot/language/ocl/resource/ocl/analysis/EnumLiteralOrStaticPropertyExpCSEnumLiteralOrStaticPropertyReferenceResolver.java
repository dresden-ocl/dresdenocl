...
public class EnumLiteralOrStaticPropertyExpCSEnumLiteralOrStaticPropertyReferenceResolver
		implements
		tudresden.ocl20.pivot.language.ocl.resource.ocl.IOclReferenceResolver<tudresden.ocl20.pivot.language.ocl.EnumLiteralOrStaticPropertyExpCS, tudresden.ocl20.pivot.pivotmodel.NamedElement> {
	...
	public void resolve(
			...
			tudresden.ocl20.pivot.language.ocl.EnumLiteralOrStaticPropertyExpCS container,
