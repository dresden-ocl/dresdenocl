...
public class ImplicitOperationCallCSOperationNameReferenceResolver
		implements
		tudresden.ocl20.pivot.language.ocl.resource.ocl.IOclReferenceResolver<tudresden.ocl20.pivot.language.ocl.ImplicitOperationCallCS, tudresden.ocl20.pivot.pivotmodel.Operation> {
	...
	public void resolve(
			...
			tudresden.ocl20.pivot.language.ocl.ImplicitOperationCallCS container,
