...
public class SelectModelPage extends WizardPage {
	...
	public SelectModelPage() {
		...
		setDescription(Ocl2JavaUIMessages.SelectModelPage_Description);
	}
	...
	private void createModelSelectionGroup(Composite parent) {
		...
		explanationText
				.setText(Ocl2JavaUIMessages.SelectModelPage_SelectModelLabel);
	...
	private void updatePageComplete() {
		...
		if (ModelBusPlugin.getModelRegistry().getModels().length == 0) {
			setErrorMessage(Ocl2JavaUIMessages.SelectModelPage_ErrorNoModelLoaded);
		}
		...
		/* Check if model selection is empty. */
			...
			if (areConstraintsInModel(this.getSelectedModel())) {
				...
				setErrorMessage(Ocl2JavaUIMessages.SelectModelPage_MessageNoConstraints);
			}
		}

		else {
			setMessage(Ocl2JavaUIMessages.SelectModelPage_MessagePleaseChooseModel);
		}
	...
	private class ModelLabelProvider extends LabelProvider implements
		...
		public Image getImage(Object element) {
			...
			result = Ocl2JavaUIPlugIn.getImageDescriptor(MODEL_IMAGE)
					.createImage();
