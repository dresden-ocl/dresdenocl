...
public class SettingsPage extends WizardPage {
	...
	private void createDestinationLanguageGroup(Composite parent) {
		...
		desLangGroup.setText(Ocl2SqlUIMessages.SettingsPage_DestinationLanguageLabel);
		...
		desLangLabel.setText(Ocl2SqlUIMessages.SettingsPage_DestinationLanguageLabel);
		
		desLangCombo = new Combo(desLangGroup,SWT.READ_ONLY);
		desLangCombo.setSize(new Point(12,10000));
		
		for (ITemplateGroup templateGroup : TemplatePlugin.getTemplateGroupRegistry().getTemplateGroups()) {
		...
		settings.setTemplateGroup(TemplatePlugin.getTemplateGroupRegistry().getTemplateGroup(desLangCombo.getText()));
	...
	private void createTablePrefixGroup(Composite parent) {
		...
		tablePrefixGroup.setLayoutData(new GridData(SWT.FILL, SWT.NONE, true, false));
		...
		tablePrefixCombo.add("T_"); tablePrefixCombo.add("PT_");
		tablePrefixCombo.setText(settings.getTablePrefix());
		
		tablePrefixCombo.addModifyListener(
				  new ModifyListener()
				  {
		...
		objectViewPrefixLabel.setText(Ocl2SqlUIMessages.SettingsPage_ObjectViewPrefixLabel);
				
		
		objectViewPrefixCombo = new Combo(tablePrefixGroup,SWT.DROP_DOWN);
		objectViewPrefixCombo.setSize(new Point(12,10000));
		
		objectViewPrefixCombo.add("OV_"); objectViewPrefixCombo.add("O_");
		objectViewPrefixCombo.setText(settings.getObjectViewPrefix());
		objectViewPrefixCombo.addModifyListener(
				  new ModifyListener()
				  {
		...
		associationPrefixLabel.setText(Ocl2SqlUIMessages.SettingsPage_AssociationPrefixLabel);
		
		
		associationPrefixCombo = new Combo(tablePrefixGroup,SWT.DROP_DOWN);
		associationPrefixCombo.setSize(new Point(12,10000));
		
		associationPrefixCombo.add("ASS_"); associationPrefixCombo.add("A_");
		associationPrefixCombo.setText(settings.getAssociationTablePrefix());
		
		associationPrefixCombo.addModifyListener(
				  new ModifyListener()
				  {
	...
	private void createKeyPrefixGroup(Composite parent) {
		...
		primaryPrefixLabel.setText(Ocl2SqlUIMessages.SettingsPage_PrimaryPrefixLabel);
		...
		primaryPrefixCombo.addModifyListener(
				  new ModifyListener()
				  {
		...
		foreignPrefixLabel.setText(Ocl2SqlUIMessages.SettingsPage_ForeignPrefixLabel);
		...
		foreignPrefixCombo.addModifyListener(
				  new ModifyListener()
				  {
	...
	public void createControl(Composite parent) {
		...
		restoreDefaultsButton = createButton(panel,
				Ocl2SqlUIMessages.SettingsPage_RestoreDefaults);
