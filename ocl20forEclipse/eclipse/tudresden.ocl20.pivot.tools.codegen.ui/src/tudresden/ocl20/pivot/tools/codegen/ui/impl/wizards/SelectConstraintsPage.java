...
public class SelectConstraintsPage extends WizardPage {
	 ...
	 */
	private ConstraintViewPage myObserver;
	...
	public SelectConstraintsPage() {
		...
		setDescription(CodegenUIMessages.SelectConstraintsPage_Description);
	}
	...
	private void createButtonGroup(Composite parent) {
		...
		allBodyCheckBox
				.setText(CodegenUIMessages.SelectConstraintsPage_SelectAllBodyExpressions);
		...
		allDefCheckBox
				.setText(CodegenUIMessages.SelectConstraintsPage_SelectAllDefinitions);
		...
		allDeriveCheckBox
				.setText(CodegenUIMessages.SelectConstraintsPage_SelectAllDerivedValues);
		...
		allInitCheckBox
				.setText(CodegenUIMessages.SelectConstraintsPage_SelectAllInitialExpressions);
		...
		allInvCheckBox
				.setText(CodegenUIMessages.SelectConstraintsPage_SelectAllInvariants);
		...
		allPreCheckBox
				.setText(CodegenUIMessages.SelectConstraintsPage_SelectAllPreconditions);
		...
		allPostCheckBox
				.setText(CodegenUIMessages.SelectConstraintsPage_SelectAllPostconditions);
	...
	private void updatePageComplete() {
		...
		if (this.areConstraintsSelected()) {
			...
			setErrorMessage(CodegenUIMessages.SelectConstraintsPage_MessageNoConstraints);
		}
