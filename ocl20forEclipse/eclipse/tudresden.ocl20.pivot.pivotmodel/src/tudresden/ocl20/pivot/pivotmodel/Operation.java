 ...
 * <ul>
 *   <li>{@link tudresden.ocl20.pivot.pivotmodel.Operation#getOwningType <em>Owning Type</em>}</li>
 *   <li>{@link tudresden.ocl20.pivot.pivotmodel.Operation#getOwnedParameter <em>Owned Parameter</em>}</li>
 *   <li>{@link tudresden.ocl20.pivot.pivotmodel.Operation#getInputParameter <em>Input Parameter</em>}</li>
 *   <li>{@link tudresden.ocl20.pivot.pivotmodel.Operation#getOutputParameter <em>Output Parameter</em>}</li>
 *   <li>{@link tudresden.ocl20.pivot.pivotmodel.Operation#getReturnParameter <em>Return Parameter</em>}</li>
 *   <li>{@link tudresden.ocl20.pivot.pivotmodel.Operation#getSignatureParameter <em>Signature Parameter</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Operation extends Feature, TypedElement, NamedElement,
	 ...
	 * bidirectional and its opposite is '{@link tudresden.ocl20.pivot.pivotmodel.Type#getOwnedOperation <em>Owned Operation</em>}'.
	...
	/**
	 * Sets the value of the '{@link tudresden.ocl20.pivot.pivotmodel.Operation#getOwningType <em>Owning Type</em>}' container reference.
	 ...
	 * list contents are of type {@link tudresden.ocl20.pivot.pivotmodel.Parameter}. It is
	 * bidirectional and its opposite is '{@link tudresden.ocl20.pivot.pivotmodel.Parameter#getOperation <em>Operation</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Input Parameter</b></em>' reference list. The list
	 * contents are of type {@link tudresden.ocl20.pivot.pivotmodel.Parameter}. <!-- begin-user-doc
	 * --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * <p>
	 * This is the subset of all parameters with direction {@link ParameterDirectionKind#IN in} or
	...
	/**
	 * Returns the value of the '<em><b>Output Parameter</b></em>' reference list. The list
	 * contents are of type {@link tudresden.ocl20.pivot.pivotmodel.Parameter}. <!-- begin-user-doc
	 * --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * <p>
	 * This is the subset of all parameters with direction {@link ParameterDirectionKind#OUT out} or
	 * {@link ParameterDirectionKind#INOUT inout}.
	 * </p>
	 * <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Signature Parameter</b></em>' reference list. The list
	 * contents are of type {@link tudresden.ocl20.pivot.pivotmodel.Parameter}. <!-- begin-user-doc
	 * --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * <p>
	 * This is the subset of all parameters except the {@link ParameterDirectionKind#RETURN return}
	 * parameter.
	 * </p>
	 * <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Return Parameter</b></em>' reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * <p>
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * <p>
	 * An additional operation defined in the OCL specification (Section 8.3.8) which checks whether
	 * the <code>Operation</code>'s signature matches with a sequence of {@link Type types}. Note
	 * that in making the match only parameters with {@link ParameterDirectionKind  direction kind}
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * <p>
	 * Adds a {@link Parameter} to this operation. This is required to define new operations via a
	 * {@link ConstraintKind#definition definition} constraint. The operation returns a reference to
	...
	/**
	 * Overridden to specialize the co-variant return type to <code>Operation</code>.
	 * 
