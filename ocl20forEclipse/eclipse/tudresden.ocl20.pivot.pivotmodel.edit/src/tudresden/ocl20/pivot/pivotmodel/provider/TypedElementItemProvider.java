...
public class TypedElementItemProvider extends NamedElementItemProvider implements
   ...
   * 
   * <p>
   * Extended the EMF implementation to add the custom {@link TypePropertyDescriptor}.
   * </p>
   * 
   * @generated NOT
   */
  protected void addTypePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(new TypePropertyDescriptor(
  ...
  protected void addGenericTypePropertyDescriptor(Object object) {
    itemPropertyDescriptors
        .add(createItemPropertyDescriptor(
            ...
            PivotModelPackageImpl.Literals.TYPED_ELEMENT__GENERIC_TYPE,false,false,false,null,null,
            null));
  }
  ...
  protected class TypePropertyDescriptor extends ItemPropertyDescriptor {
    ...
    public TypePropertyDescriptor(String displayName, String description) {
      super(((ComposeableAdapterFactory) getAdapterFactory()).getRootAdapterFactory(),
          ...
          PivotModelPackageImpl.Literals.TYPED_ELEMENT__TYPE,true,false,true,null,null,null);
    }

    /**
     * Returns the normal choices (i.e, all {@link Type}s in the model) as well as the
     * {@link TypeParameter}s of all owning elements.
     * 
    ...
    public Collection<?> getChoiceOfValues(Object object) {
      ...
      for (NamedElement e = (NamedElement) object; e != null; e = e.getOwner()) {
        ...
        // the owner (operation, type, namespace) should usually be a GenericElement
    ...
    public void setPropertyValue(Object object, Object value) {
      ...
      if (value instanceof TypeParameter) {
        ...
        // create a new generic type for type parameters and set its referenced type parameter
        ParameterGenericType genericType = PivotModelFactory.INSTANCE.createParameterGenericType();
    ...
    /**
     * Helper method that sets the generic type on a {@link TypedElement}. Uses a
     * <code>SetCommand</code> for this purpose so the action can be undone.
     * 
     * @param genericType
     */
    protected void setGenericType(TypedElement typedElement, GenericType genericType) {
      EditingDomain editingDomain = getEditingDomain(typedElement);

      if (editingDomain != null) {
        editingDomain.getCommandStack().execute(
            SetCommand.create(editingDomain,typedElement,
                PivotModelPackageImpl.Literals.TYPED_ELEMENT__GENERIC_TYPE,genericType));
      }
  ...
  /**
   * Overridden to return the type arguments of the generic type of the adapted {@link TypedElement}.
   * 
  ...
  public Collection<?> getChildren(Object object) {
    ...
    // check if the typed element has a generic type and that one is a ComplexGenericType
    if (typedElement.getGenericType() != null
        && typedElement.getGenericType() instanceof ComplexGenericType) {
      ComplexGenericType genericType = (ComplexGenericType) typedElement.getGenericType();
   ...
   * 
   * <p>
   * The EMF implementation is extended to append the type of the {@link TypedElement}. This is a
   * template method that can be extended by subclasses by overriding
   * {@link #getTypedElementName(TypedElement)}.
   * </p>
   * 
   * @generated NOT
   */
  ...
  public String getText(Object object) {
    ...
    label = new StringBuilder(getTypedElementName(typedElement));

    CharSequence typeName = getTypedElementTypeName(typedElement);
  ...
  /**
   * This method can be overridden in subclasses to specify the rendering of the name of the
   * {@link TypedElement}. This default implementation simply returns the name of the
   * <code>TypedElement</code> unchanged.
   * 
   * @param typedElement the <code>TypedElement</code> instance
   * 
   * @return a <code>String</code> with the name of the <code>TypedElement</code>
   */
  ...
  /**
   * Helper method to return a representation of the type of the {@link TypedElement}. This is
   * either the name of the {@link Type} or the name of the {@link GenericType} of the
   * <code>TypedElement</code>. If neither a type nor a generic type is set, the empty string is
   * returned.
   * 
   * @param typedElement the <code>TypedElement</code> instance
   * 
   * @return a <code>String</code> representing the type of the <code>TypedElement</code>
   */
  protected CharSequence getTypedElementTypeName(TypedElement typedElement) {
    return typedElement.getType() != null ? getTypeName(typedElement.getType()) : (typedElement
        .getGenericType() != null ? getGenericTypeName(typedElement.getGenericType()) : ""); //$NON-NLS-1$
  }
  ...
  /**
   * Helper method to return the name of the {@link GenericType} of a {@link TypedElement}. This
   * default implementation delegates to {@link GenericTypeItemProvider#getText()} for determining
   * the rendering.
   * 
   * @param genericType the <code>GenericType</code>, guaranteed not to be <code>null</code>
   * 
