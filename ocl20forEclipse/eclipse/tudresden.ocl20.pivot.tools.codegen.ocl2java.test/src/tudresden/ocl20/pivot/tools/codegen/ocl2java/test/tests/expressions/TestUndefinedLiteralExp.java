 ...
 * @author Claas Wilke
 */
public class TestUndefinedLiteralExp extends AbstractDiffTest {
	 ...
	 */
	@Test
	public void testUndefined01() throws Exception {

		this.compareFragmentCodeGeneration("expressions/literals", "undefined01");
	}
}