...
public privileged aspect Service_PostAspect_upgradePointsEarned {
    ...
    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Service#upgradePointsEarned(Integer amount)}.</p>
     */
    protected pointcut upgradePointsEarnedCaller(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Service aClass, Integer amount):
    	call(* org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Service.upgradePointsEarned(Integer))
     ...
     */
    void around(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Service aClass, Integer amount): upgradePointsEarnedCaller(aClass, amount) {
