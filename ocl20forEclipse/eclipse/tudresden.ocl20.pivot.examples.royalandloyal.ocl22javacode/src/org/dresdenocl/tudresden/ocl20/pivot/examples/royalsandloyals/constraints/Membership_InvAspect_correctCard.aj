...
public privileged aspect Membership_InvAspect_correctCard {
    ...
    declare parents: org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Membership implements tudresden.ocl20.pivot.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Membership.checkInvariants() {
    ...
    after(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Membership aClass) : checkInvariantsCaller(aClass) {
        ...
        java.util.ArrayList<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard> result1;
        result1 = new java.util.ArrayList<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard>();

        /* Iterator Collect: Iterate through all elements and collect them. Elements which are collections are flattened. */
        for (org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Customer anElement1 : aClass.program.participants) {
            result1.addAll(anElement1.cards);
        }

        if (!tudresden.ocl20.pivot.tools.codegen.ocl2java.types.util.OclCollections.includes((java.util.List<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard>) tudresden.ocl20.pivot.tools.codegen.ocl2java.types.util.OclBags.flatten(result1), aClass.card)) {
