...
public privileged aspect LoyaltyAccount_PostAspect_isEmpty {
    ...
    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount#isEmpty()}.</p>
     */
    protected pointcut isEmptyCaller(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount aClass):
    	call(* org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount.isEmpty())
    	&& target(aClass);
     ...
     */
    Boolean around(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount aClass): isEmptyCaller(aClass) {
