...
public privileged aspect LoyaltyAccount_DeriveAspect_totalPointsEarned {
    ...
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount#totalPointsEarned}.</p>
     */
    protected pointcut totalPointsEarnedGetter(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount aClass) :
     ...
     */
    before(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount aClass): totalPointsEarnedGetter(aClass) {
        ...
        for (org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Transaction anElement1 : aClass.transactions) {
            if (anElement1.getClass().getCanonicalName().equals(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Earning.class.getCanonicalName())) {
