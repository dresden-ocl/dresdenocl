...
public privileged aspect CustomerCard_InvAspect_checkDates {
    ...
    /**
     * <p>Pointcut for all changes of the attribute {@link org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard#validFrom}.</p>
     */
    protected pointcut validFromSetter(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard aClass) :
        set(* org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard.validFrom) && target(aClass); 

    /**
     * <p>Pointcut for all changes of the attribute {@link org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard#validThru}.</p>
     */
    protected pointcut validThruSetter(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard aClass) :
        set(* org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard.validThru) && target(aClass); 

    /**
     * <p>Pointcut to collect all attributeSetters.</p>
     */
    protected pointcut allSetters(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard aClass) :
     ...
     */
    after(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard aClass) : allCustomerCardConstructors(aClass) || allSetters(aClass) {
