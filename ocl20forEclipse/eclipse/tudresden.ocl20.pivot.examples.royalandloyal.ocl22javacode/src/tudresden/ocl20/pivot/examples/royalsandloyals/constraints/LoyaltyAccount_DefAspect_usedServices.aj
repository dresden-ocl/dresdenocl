...
public privileged aspect LoyaltyAccount_DefAspect_usedServices {
     ...
     */
    public java.util.Set<tudresden.ocl20.pivot.examples.royalsandloyals.Service> tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount.getUsedServices() {
    ...
    before(tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount aClass): usedServicesGetter(aClass) {
        ...
        for (tudresden.ocl20.pivot.examples.royalsandloyals.Transaction $implicitCollect0$ : aClass.transactions) {
            result1.add($implicitCollect0$.service);
        }
