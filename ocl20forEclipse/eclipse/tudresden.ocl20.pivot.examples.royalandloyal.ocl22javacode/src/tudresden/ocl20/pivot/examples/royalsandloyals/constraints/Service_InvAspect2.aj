...
public privileged aspect Service_InvAspect2 {
    ...
    declare parents: tudresden.ocl20.pivot.examples.royalsandloyals.Service implements tudresden.ocl20.pivot.tools.codegen.ocl2java.types.OclCheckable;
    
    public void tudresden.ocl20.pivot.examples.royalsandloyals.Service.checkInvariants() {
