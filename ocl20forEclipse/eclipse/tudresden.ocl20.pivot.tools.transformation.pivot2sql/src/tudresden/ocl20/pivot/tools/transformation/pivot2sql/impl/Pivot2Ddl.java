 ...
 *
 */
public class Pivot2Ddl extends SequentialTransformations<Namespace,Schema,String> {
	...
	public Pivot2Ddl(String modelInName, String outName) throws Exception {
		super(modelInName, outName, Pivot2CwmImpl.class.getSimpleName(), Cwm2DdlImpl.class.getSimpleName());
