...
import tudresden.ocl20.pivot.ocl2parser.testcasegenerator.abstractsyntax.IKindElement;
import tudresden.ocl20.pivot.ocl2parser.testcasegenerator.abstractsyntax.ITokenAS;

abstract public class KindElement extends ComplexElement implements IKindElement {
	public KindElement(String typename) {
		super(typename);
	}
	
	public KindElement(ITokenAS token, String typename) {
