...
import tudresden.ocl20.pivot.ocl2parser.testcasegenerator.abstractsyntax.ISimpleElement;
import tudresden.ocl20.pivot.ocl2parser.testcasegenerator.abstractsyntax.ITokenAS;

public abstract class SimpleElement extends ModelExpression implements ISimpleElement {
	public SimpleElement(String typename) {
		super(typename);
		setPackageName(Messages.getString("JavaLangPackage"));
	}
	
	public SimpleElement(ITokenAS token, String typename) {
