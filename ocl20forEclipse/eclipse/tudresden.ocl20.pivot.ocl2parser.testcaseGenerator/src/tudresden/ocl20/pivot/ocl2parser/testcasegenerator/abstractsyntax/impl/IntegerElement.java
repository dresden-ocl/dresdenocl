...
public class IntegerElement extends SimpleElement implements IIntegerElement {
	//private TokenAS integerToken = null;
	
	public IntegerElement() {
		super(Messages.getString("IntegerTypeName"));
	}
	
	public IntegerElement(ITokenAS token) {
		super(token, Messages.getString("IntegerTypeName"));
	}
	/*public IntegerElement() {
		super("int");
	}
	...
	public IntegerElement(TokenAS value) {
		super(value, "int");
	}*/

	public void accept(IVisitor visitor, IEnvironment env) throws BuildingASMException {
		visitor.visitIntegerElement(this, env);
	}

	public void accept(IVisitorCodeGen visitor, StringBuffer buffer)
			throws BuildingASMException {
		visitor.visitIntegerElement(this, buffer);
		
	}

	/*public TokenAS getIntegerToken() {
		return integerToken;
	}

	public void setIntegerToken(TokenAS integerToken) {
