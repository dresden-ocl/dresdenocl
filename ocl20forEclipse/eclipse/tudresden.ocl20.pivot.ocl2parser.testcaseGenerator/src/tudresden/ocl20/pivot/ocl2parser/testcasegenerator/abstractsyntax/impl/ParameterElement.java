...
public class ParameterElement extends PivotmodelReferenceElement implements IParameterElement {
	//private TokenAS parameterNameToken = null;
	
	public ParameterElement() {
		super(Messages.getString("ParameterName"));
	}
	
	public ParameterElement(ITokenAS token) {
		super(token, Messages.getString("ParameterName"));
	}
	public void accept(IVisitor visitor, IEnvironment env) throws BuildingASMException {
		visitor.visitParameterElement(this, env);
	}

	public void accept(IVisitorCodeGen visitor, StringBuffer buffer)
			throws BuildingASMException {
		visitor.visitParameterElement(this, buffer);
