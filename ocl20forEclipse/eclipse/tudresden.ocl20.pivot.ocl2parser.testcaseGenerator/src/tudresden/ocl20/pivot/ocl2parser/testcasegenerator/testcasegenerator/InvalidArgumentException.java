...
package tudresden.ocl20.pivot.ocl2parser.testcasegenerator.testcasegenerator;

public class InvalidArgumentException extends Exception {
	private String parameterName;
	private String value;
	
	public InvalidArgumentException(String parameterName, String value) {
		this.parameterName = parameterName;
		this.value = value;
	}
	
	public String getMessage() {
		return super.getMessage() + " The parameter " + parameterName + " has an invalid value. The value was " + value;
	}
}
