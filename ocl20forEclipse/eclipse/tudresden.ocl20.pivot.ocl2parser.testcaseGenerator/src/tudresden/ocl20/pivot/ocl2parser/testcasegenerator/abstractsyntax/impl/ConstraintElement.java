...
public class ConstraintElement extends PivotmodelReferenceElement implements
		IConstraintElement {

	public ConstraintElement() {
		super(Messages.getString("ConstraintName"));
	}
	
	public ConstraintElement(ITokenAS token) {
		super(token, Messages.getString("ConstraintName"));
	}
	
	public void accept(IVisitor visitor, IEnvironment env)
			throws BuildingASMException {
		visitor.visitConstraintElement(this, env);
	}

	public void accept(IVisitorCodeGen visitor, StringBuffer buffer)
			throws BuildingASMException {
		visitor.visitConstraintElement(this, buffer);
