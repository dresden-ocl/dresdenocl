...
public class TypeMap extends Object {
    ...
    private void initializePackageDirectory() {
        ...
        addPackage(m, "tudresden.ocl20.pivot.ocl2parser.testcasegenerator.abstractsyntax", new String[] 
            {
                "ITest",
                "ITestSuite",
                "IPackageDeclaration",
                ...
                "IVariable",
                "IModelExpression",
                "IEssentialOCLElement",
                "IReferenceElement",
                "ITypeElement",
                "IOperationElement",
                "IEnumerationLiteralElement",
                "IPropertyElement",
                "ICollectionKindElement",
                "IConstraintKindElement",
                "IListElement",
                "IStringElement",
                "INullElement"
            }
