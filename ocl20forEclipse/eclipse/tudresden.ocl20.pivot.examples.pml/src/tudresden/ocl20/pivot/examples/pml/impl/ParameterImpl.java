 ...
 * <ul>
 * <li>{@link tudresden.ocl20.pivot.examples.pml.impl.ParameterImpl#getName <em>
 * Name</em>}</li>
 * <li>{@link tudresden.ocl20.pivot.examples.pml.impl.ParameterImpl#getType <em>
 * Type</em>}</li>
 * <li>
 * {@link tudresden.ocl20.pivot.examples.pml.impl.ParameterImpl#getOperation
 * <em>Operation</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ParameterImpl extends EObjectImpl implements Parameter {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PmlPackage.PARAMETER__NAME, oldName, name));
	}
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmlPackage.PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public Operation getOperation() {
		...
		if (eContainerFeatureID() != PmlPackage.PARAMETER__OPERATION)
			return null;
	...
	public NotificationChain basicSetOperation(Operation newOperation,
		...
		msgs =
				eBasicSetContainer((InternalEObject) newOperation,
						PmlPackage.PARAMETER__OPERATION, msgs);
		return msgs;
	}
	...
	public void setOperation(Operation newOperation) {
		...
		if (newOperation != eInternalContainer()
				|| (eContainerFeatureID() != PmlPackage.PARAMETER__OPERATION && newOperation != null)) {
			...
			if (newOperation != null)
				msgs =
						((InternalEObject) newOperation).eInverseAdd(this,
								PmlPackage.OPERATION__PARAMETERS, Operation.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PmlPackage.PARAMETER__OPERATION, newOperation, newOperation));
	}
