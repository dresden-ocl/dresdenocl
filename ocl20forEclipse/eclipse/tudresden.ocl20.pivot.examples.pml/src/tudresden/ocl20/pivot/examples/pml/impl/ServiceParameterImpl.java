 ...
 * @generated
 */
public class ServiceParameterImpl extends EObjectImpl implements
		ServiceParameter {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PMLPackage.SERVICE_PARAMETER__NAME, oldName, name));
	}
	...
	public Service getService() {
		if (eContainerFeatureID != PMLPackage.SERVICE_PARAMETER__SERVICE)
			return null;
	...
	public NotificationChain basicSetService(Service newService,
		...
		msgs = eBasicSetContainer((InternalEObject) newService,
				PMLPackage.SERVICE_PARAMETER__SERVICE, msgs);
		return msgs;
	}
		...
		if (newService != eInternalContainer()
			...
			if (newService != null)
				msgs = ((InternalEObject) newService).eInverseAdd(this,
						PMLPackage.SERVICE__PARAMETERS, Service.class, msgs);
			msgs = basicSetService(newService, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PMLPackage.SERVICE_PARAMETER__SERVICE, newService,
					newService));
	}
