...
public class ServiceParameterImpl extends EObjectImpl implements ServiceParameter {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmlPackage.SERVICE_PARAMETER__NAME, oldName, name));
	}
	...
	public JavaType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmlPackage.SERVICE_PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(JavaType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmlPackage.SERVICE_PARAMETER__TYPE, oldType, type));
	}
	...
	public NotificationChain basicSetService(Service newService, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newService, PmlPackage.SERVICE_PARAMETER__SERVICE, msgs);
		return msgs;
	}
	...
	public void setService(Service newService) {
		if (newService != eInternalContainer() || (eContainerFeatureID() != PmlPackage.SERVICE_PARAMETER__SERVICE && newService != null)) {
			...
			if (newService != null)
				msgs = ((InternalEObject)newService).eInverseAdd(this, PmlPackage.SERVICE__PARAMETERS, Service.class, msgs);
			msgs = basicSetService(newService, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmlPackage.SERVICE_PARAMETER__SERVICE, newService, newService));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case PmlPackage.SERVICE_PARAMETER__SERVICE:
				return eInternalContainer().eInverseRemove(this, PmlPackage.SERVICE__PARAMETERS, Service.class, msgs);
		}
