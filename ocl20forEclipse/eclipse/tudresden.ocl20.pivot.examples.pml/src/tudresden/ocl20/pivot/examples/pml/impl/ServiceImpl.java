...
public class ServiceImpl extends EObjectImpl implements Service {
	...
	public void setPlugin(Plugin newPlugin) {
		if (newPlugin != eInternalContainer() || (eContainerFeatureID() != PmlPackage.SERVICE__PLUGIN && newPlugin != null)) {
			...
			if (newPlugin != null)
				msgs = ((InternalEObject)newPlugin).eInverseAdd(this, PmlPackage.PLUGIN__SERVICES, Plugin.class, msgs);
			msgs = basicSetPlugin(newPlugin, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmlPackage.SERVICE__PLUGIN, newPlugin, newPlugin));
	}
	...
	public JavaType getReturnType() {
		if (returnType != null && returnType.eIsProxy()) {
			...
			if (returnType != oldReturnType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmlPackage.SERVICE__RETURN_TYPE, oldReturnType, returnType));
			}
		}
		return returnType;
	}
	...
	public void setReturnType(JavaType newReturnType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmlPackage.SERVICE__RETURN_TYPE, oldReturnType, returnType));
	}
	...
	public EList<ServiceParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentWithInverseEList<ServiceParameter>(ServiceParameter.class, this, PmlPackage.SERVICE__PARAMETERS, PmlPackage.SERVICE_PARAMETER__SERVICE);
		}
		return parameters;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case PmlPackage.SERVICE__PLUGIN:
				return eInternalContainer().eInverseRemove(this, PmlPackage.PLUGIN__SERVICES, Plugin.class, msgs);
		}
