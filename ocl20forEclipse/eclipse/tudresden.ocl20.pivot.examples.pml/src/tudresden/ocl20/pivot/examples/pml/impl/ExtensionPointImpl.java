 ...
 * <ul>
 * <li>{@link tudresden.ocl20.pivot.examples.pml.impl.ExtensionPointImpl#getId
 * <em>Id</em>}</li>
 * <li>
 * {@link tudresden.ocl20.pivot.examples.pml.impl.ExtensionPointImpl#getPlugin
 * <em>Plugin</em>}</li>
 * <li>
 * {@link tudresden.ocl20.pivot.examples.pml.impl.ExtensionPointImpl#getInterface
 * <em>Interface</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ExtensionPointImpl extends EObjectImpl implements ExtensionPoint {
	...
	public NotificationChain basicSetPlugin(Plugin newPlugin,
		...
		msgs =
				eBasicSetContainer((InternalEObject) newPlugin,
	...
	public void setPlugin(Plugin newPlugin) {
		...
		if (newPlugin != eInternalContainer()
			...
			if (newPlugin != null)
				msgs =
						((InternalEObject) newPlugin).eInverseAdd(this,
			...
			if (interface_ != oldInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmlPackage.EXTENSION_POINT__INTERFACE, oldInterface, interface_));
			}
		}
		return interface_;
	}
