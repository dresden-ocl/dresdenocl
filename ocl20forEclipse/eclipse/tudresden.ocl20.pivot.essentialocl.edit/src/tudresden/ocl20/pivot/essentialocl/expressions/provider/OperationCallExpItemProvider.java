...
/**
 * This is the item provider adapter for a {@link tudresden.ocl20.pivot.essentialocl.expressions.OperationCallExp} object.
...
public class OperationCallExpItemProvider extends FeatureCallExpItemProvider
	...
	protected void addReferredOperationPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						ExpressionsPackageImpl.Literals.OPERATION_CALL_EXP__REFERRED_OPERATION,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ExpressionsPackageImpl.Literals.OPERATION_CALL_EXP__ARGUMENT);
		}
	...
	public String getText(Object object) {
		...
		String label = ((OperationCallExp) object).getReferredOperation().getName();
		return label;
	}
