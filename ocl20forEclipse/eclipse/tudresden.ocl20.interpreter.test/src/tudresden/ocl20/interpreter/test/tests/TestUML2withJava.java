...
public class TestUML2withJava {
	...
	protected final static String MODEL_INSTANCE_TYPE = "tudresden.ocl20.pivot.modelinstancetype.java";

	/** The name of the bundle of the model file. */
	protected final static String MODEL_BUNDLE = "tudresden.ocl20.pivot.examples.royalandloyal";

	/** The path of the UML model file. */
	protected final static String MODEL_FILE = "model/royalsandloyals.uml";

	/** The path of the UML model instance file. */
	protected final static String MODEL_INSTANCE_FILE = "bin/tudresden/ocl20/pivot/examples/royalsandloyals/ModelProviderClass.class";
	...
	public static void setUp() {
		...
		testPerformer.setMetaModel(META_MODEL);
		testPerformer.setModelBundle(MODEL_BUNDLE);
		testPerformer.setModelFile(MODEL_FILE);
		testPerformer.setModelInstanceFile(MODEL_INSTANCE_FILE);
		testPerformer.setModelInstanceType(MODEL_INSTANCE_TYPE);
