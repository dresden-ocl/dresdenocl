...
public class SimpleFactoryImpl extends EFactoryImpl implements SimpleFactory {
	...
	public static SimpleFactory init() {
		try {
			SimpleFactory theSimpleFactory = (SimpleFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.tu-dresden.de/ocl20/pivot/examples/simple"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SimplePackage.PERSON: return createPerson();
			case SimplePackage.PROFESSOR: return createProfessor();
			case SimplePackage.STUDENT: return createStudent();
			case SimplePackage.MODEL_PROVIDER_CLASS: return createModelProviderClass();
			default:
	 ...
	 * @generated
	 */
	public ModelProviderClass createModelProviderClass() {
		ModelProviderClassImpl modelProviderClass = new ModelProviderClassImpl();
