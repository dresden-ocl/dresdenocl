...
/**
 * The {@link ITemplateGroup} contains a {@link ITemplateEngine}, {@link ITemplate}s and a super {@link ITemplateGroup}.
 * The files can redefined {@link ITemplate}s from the super group. Are {@link ITemplates} not defined in this group get it from the super group.
 *
...
public interface ITemplateGroup {
	 ...
	 * @return
	 * 		the name of the TemplateGroup
	 */
	public String getDisplayName();
	
	/**
	 * Returns the super {@link ITemplateGroup} or <code>null</code> is there no super group.
	 * @return
	 * 		the super {@link ITemplateGroup} or <code>null</null>
	 */
