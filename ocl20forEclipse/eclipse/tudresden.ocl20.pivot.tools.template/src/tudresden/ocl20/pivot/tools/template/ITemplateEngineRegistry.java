...
/**
 * <p>
 * The {@link ITemplateEngineRegistry} manages a list of {@link ITemplateEngine}s that are
 * currently available.
 * </p>
 * 
...
public interface ITemplateEngineRegistry {
	...
	/**
	 * <p>
	 * Returns a new instance of the {@link ITemplateEngine} with the given name or <code>null</code> if no
	 * {@link ITemplateEngine} with that name is registered.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Removes an {@link ITemplateEngine} from this {@link ITemplateEngineRegistry}.
	 * </p>
	 * @param templateEngine
	...
	/**
	 * <p>
	 * Adds an {@link ITemplateEngineRegistryListener} to this {@link ITemplateEngineRegistry}.
	 * </p>
	 * 
	 * @param listener
	 *          The {@link ITemplateEngineRegistryListener} to be added.
	 */
	void addTemplateEngineRegistryListener(ITemplateEngineRegistryListener listener);

	/**
	 * <p>
	 * Removes an {@link ITemplateEngineRegistryListener} from this {@link ITemplateEngineRegistry}.
	 * </p>
	 * 
	 * @param listener
	 *          The {@link ITemplateEngineRegistryListener} to be removed.
	 */
	void removeTemplateEngineRegistryListener(ITemplateEngineRegistryListener listener);
