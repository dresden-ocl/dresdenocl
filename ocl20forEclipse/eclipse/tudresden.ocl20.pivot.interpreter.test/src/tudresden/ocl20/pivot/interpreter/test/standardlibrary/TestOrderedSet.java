 ...
 * <code>OrderedSets</code>s.
 * </p>
 * 
 * @author Claas Wilke
 */
public class TestOrderedSet extends AbstractInterpreterTest {

	/** The name of the constraint directory for this test suite. */
	private static final String CONSTRAINT_DIRECTORY = "standardlibrary/orderedset";
