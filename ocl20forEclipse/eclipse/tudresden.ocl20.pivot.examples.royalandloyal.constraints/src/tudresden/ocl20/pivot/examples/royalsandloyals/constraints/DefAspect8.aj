...
public privileged aspect DefAspect8 {
     ...
     */
    tudresden.ocl20.pivot.ocl2java.types.OclSet<tudresden.ocl20.pivot.examples.royalsandloyals.Transaction> around(tudresden.ocl20.pivot.examples.royalsandloyals.ProgramPartner aClass): getBurningTransactionsCaller(aClass) {
        tudresden.ocl20.pivot.ocl2java.types.OclBag<tudresden.ocl20.pivot.examples.royalsandloyals.Transaction> result1;
        result1 = new tudresden.ocl20.pivot.ocl2java.types.OclBag<tudresden.ocl20.pivot.examples.royalsandloyals.Transaction>();
        ...
        tudresden.ocl20.pivot.ocl2java.types.OclSet<tudresden.ocl20.pivot.examples.royalsandloyals.Transaction> resultSet;
        ...
        for (tudresden.ocl20.pivot.examples.royalsandloyals.Transaction anElement2 : result1) {
            tudresden.ocl20.pivot.ocl2java.types.OclSet<tudresden.ocl20.pivot.examples.royalsandloyals.Transaction> ifExpResult1;
            
            if (anElement2.getClass().getCanonicalName().equals("tudresden.ocl20.pivot.examples.royalsandloyals.Burning")) {
                ifExpResult1 = resultSet.including(anElement2);
            } else {
