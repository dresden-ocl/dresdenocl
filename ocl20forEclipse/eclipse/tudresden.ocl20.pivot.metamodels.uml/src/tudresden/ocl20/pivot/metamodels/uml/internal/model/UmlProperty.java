 ...
 */
public class UmlProperty extends AbstractProperty implements Property {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(UmlProperty.class);
	
	// the adapted UML attribute
	private Attribute attribute;

	/**
	 * Creates a new <code>UmlProperty</code> instance.
	 * 
	 * @param attribute the {@link Attribute} adapted by this class
	 */
	public UmlProperty(Attribute attribute) {
		if (logger.isDebugEnabled()) {
			logger
					.debug("UmlProperty(Attribute attribute=" + attribute + ") - enter");
		}

		this.attribute = attribute;

		if (logger.isDebugEnabled()) {
			logger.debug("UmlProperty(Attribute) - exit");
		}
	}
	...
	public Type getOwningType() {
		...
		Type returnType = UmlAdapterFactory.INSTANCE.createType(attribute
				.getOwner());
		if (logger.isDebugEnabled()) {
