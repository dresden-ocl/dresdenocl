...
public class Pivot2DdlAndMappedModelTest {
		...
		private void run(int modus) {
			...
			//run Pivot2Ddl:
			ITransformation<Namespace,IOcl2DeclSettings,Tuple<String,IMappedModel>> p2dmm = Ocl2ForEclipseFacade.getParallelTransformation("Pivot2DdlAndMappedModel",Namespace.class,String.class,IMappedModel.class,IOcl2DeclSettings.class,"pivot","ddl&mappedmodel");
			...
			ITransformation<Namespace,IOcl2DeclSettings,String> p2d = Ocl2ForEclipseFacade.getTransformation("Pivot2Ddl",Namespace.class,String.class,IOcl2DeclSettings.class,"pivot","ddl");
			...
			ITransformation<Namespace,IOcl2DeclSettings,IMappedModel> p2mm = Ocl2ForEclipseFacade.getTransformation("Pivot2MappedModelImpl",Namespace.class,IMappedModel.class,IOcl2DeclSettings.class,"pivot","mappedmodel");
