...
@Suite.SuiteClasses( { TestContext.class, TestPostconditionOperations.class,
		CollectionRangeTest.class, CollectionTest.class, DefinitionTest.class,
		IncludesAllTest.class, IncludesTest.class, IsUniqueTest.class,
		IteratorOclIsTypeOfTest.class, LetExpTest.class, OclFilesTest.class,
		PropertyOutput.class, StaticPropertyTest.class })
