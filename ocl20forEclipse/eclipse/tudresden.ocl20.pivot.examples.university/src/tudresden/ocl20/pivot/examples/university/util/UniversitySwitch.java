 ...
 * @generated
 */
public class UniversitySwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UniversityPackage.EMPLOYEE: {
			...
			case UniversityPackage.PH_DSTUDENT: {
				PhDStudent phDStudent = (PhDStudent)theEObject;
				T result = casePhDStudent(phDStudent);
				if (result == null) result = caseEmployee(phDStudent);
				if (result == null) result = casePerson(phDStudent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ph DStudent</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ph DStudent</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePhDStudent(PhDStudent object) {
		return null;
	}
