...
public class UniversityFactoryImpl extends EFactoryImpl implements UniversityFactory {
	...
	public static UniversityFactory init() {
		try {
			UniversityFactory theUniversityFactory = (UniversityFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.emftext.org/language/university"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case UniversityPackage.PERSON: return createPerson();
			case UniversityPackage.STUDENT: return createStudent();
			case UniversityPackage.EMPLOYEE: return createEmployee();
			case UniversityPackage.PH_DSTUDENT: return createPhDStudent();
			default:
	 ...
	 * @generated
	 */
	public PhDStudent createPhDStudent() {
		PhDStudentImpl phDStudent = new PhDStudentImpl();
		return phDStudent;
	}
