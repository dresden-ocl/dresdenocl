...
/**
 * This is the item provider adapter for a {@link tudresden.ocl20.pivot.language.ocl.IterateExpCS} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IterateExpCSItemProvider
	extends LoopExpCSItemProvider
	implements
	 ...
	 * @generated
	 */
	public IterateExpCSItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OclPackage.Literals.ITERATE_EXP_CS__ITERATOR_VARIABLE);
			childrenFeatures.add(OclPackage.Literals.ITERATE_EXP_CS__RESULT_VARIABLE);
			childrenFeatures.add(OclPackage.Literals.ITERATE_EXP_CS__BODY_EXPRESSION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IterateExpCS"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IterateExpCS.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.ITERATE_EXP_CS__ITERATOR_VARIABLE,
				 OclFactory.eINSTANCE.createIteratorExpVariableCS()));

		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.ITERATE_EXP_CS__RESULT_VARIABLE,
				 OclFactory.eINSTANCE.createVariableDeclarationWithInitCS()));

		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.ITERATE_EXP_CS__BODY_EXPRESSION,
