 ...
 * @generated
 */
public class IteratorExpCSItemProvider extends LoopExpCSItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OclPackage.Literals.ITERATOR_EXP_CS__ITERATOR_NAME);
			childrenFeatures
					.add(OclPackage.Literals.ITERATOR_EXP_CS__ITERATOR_VARIABLES);
			childrenFeatures
					.add(OclPackage.Literals.ITERATOR_EXP_CS__BODY_EXPRESSION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/IteratorExpCS"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				OclPackage.Literals.ITERATOR_EXP_CS__ITERATOR_NAME, ""));

		newChildDescriptors.add(createChildParameter(
				OclPackage.Literals.ITERATOR_EXP_CS__ITERATOR_VARIABLES,
				OclFactory.eINSTANCE.createIteratorExpVariableCS()));

		newChildDescriptors.add(createChildParameter(
				OclPackage.Literals.ITERATOR_EXP_CS__BODY_EXPRESSION,
