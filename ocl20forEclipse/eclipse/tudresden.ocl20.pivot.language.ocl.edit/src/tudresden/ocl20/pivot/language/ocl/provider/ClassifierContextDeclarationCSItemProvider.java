 ...
 * @generated
 */
public class ClassifierContextDeclarationCSItemProvider
	extends ContextDeclarationCSItemProvider
	implements
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.CLASSIFIER_CONTEXT_DECLARATION_CS__INVARIANTS_AND_DEFINITIONS,
				 OclFactory.eINSTANCE.createInvariantExpCS()));

		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.CLASSIFIER_CONTEXT_DECLARATION_CS__INVARIANTS_AND_DEFINITIONS,
				 OclFactory.eINSTANCE.createDefinitionExpCS()));
	}
