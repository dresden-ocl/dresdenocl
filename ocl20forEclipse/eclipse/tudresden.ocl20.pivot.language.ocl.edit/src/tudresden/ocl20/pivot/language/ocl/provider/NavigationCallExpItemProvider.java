...
/**
 * This is the item provider adapter for a {@link tudresden.ocl20.pivot.language.ocl.NavigationCallExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NavigationCallExpItemProvider
	extends FeatureCallExpCSItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NavigationCallExp_navigationOperator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NavigationCallExp_navigationOperator_feature", "_UI_NavigationCallExp_type"),
				 OclPackage.Literals.NAVIGATION_CALL_EXP__NAVIGATION_OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OclPackage.Literals.NAVIGATION_CALL_EXP__SOURCE);
			childrenFeatures.add(OclPackage.Literals.NAVIGATION_CALL_EXP__FEATURE_CALLS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.NAVIGATION_CALL_EXP__SOURCE,
		...
		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.NAVIGATION_CALL_EXP__FEATURE_CALLS,
				 OclFactory.eINSTANCE.createIteratorExpCS()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.NAVIGATION_CALL_EXP__FEATURE_CALLS,
				 OclFactory.eINSTANCE.createImplicitPropertyCallCS()));

		newChildDescriptors.add
			(createChildParameter
				(OclPackage.Literals.NAVIGATION_CALL_EXP__FEATURE_CALLS,
				 OclFactory.eINSTANCE.createImplicitOperationCallCS()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == OclPackage.Literals.NAVIGATION_CALL_EXP__SOURCE ||
			childFeature == OclPackage.Literals.NAVIGATION_CALL_EXP__FEATURE_CALLS;
