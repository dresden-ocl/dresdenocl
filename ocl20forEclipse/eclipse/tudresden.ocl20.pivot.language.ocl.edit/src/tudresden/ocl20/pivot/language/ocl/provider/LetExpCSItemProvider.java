 ...
 * {@link tudresden.ocl20.pivot.language.ocl.LetExpCS} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class LetExpCSItemProvider extends OclExpressionCSItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OclPackage.Literals.LET_EXP_CS__VARIABLE_DECLARATIONS);
			childrenFeatures
					.add(OclPackage.Literals.LET_EXP_CS__OCL_EXPRESSION);
		}
	...
	/**
	 * This returns LetExpCS.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/LetExpCS"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				OclPackage.Literals.LET_EXP_CS__VARIABLE_DECLARATIONS,
				OclFactory.eINSTANCE.createVariableDeclarationWithInitCS()));

		newChildDescriptors.add(createChildParameter(
				OclPackage.Literals.LET_EXP_CS__OCL_EXPRESSION,
