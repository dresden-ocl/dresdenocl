 ...
 * {@link tudresden.ocl20.pivot.language.ocl.ImplicitOperationCallCS} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ImplicitOperationCallCSItemProvider extends
		ImplicitFeatureCallCSItemProvider implements
	 ...
	 * @generated
	 */
	public ImplicitOperationCallCSItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addIsMarkedPrePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_OperationCallBaseExpCS_isMarkedPre_feature",
						"_UI_OperationCallBaseExpCS_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OclPackage.Literals.OPERATION_CALL_BASE_EXP_CS__ARGUMENTS);
		}
	...
	/**
	 * This returns ImplicitOperationCallCS.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/ImplicitOperationCallCS"));
	}
	...
	public String getText(Object object) {
		ImplicitOperationCallCS implicitOperationCallCS = (ImplicitOperationCallCS) object;
		StringBuffer result = new StringBuffer();

		result.append(implicitOperationCallCS.getOperationName().getName());

		if (implicitOperationCallCS.isIsMarkedPre())
			result.append("@pre");
		// no else.
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ImplicitOperationCallCS.class)) {
