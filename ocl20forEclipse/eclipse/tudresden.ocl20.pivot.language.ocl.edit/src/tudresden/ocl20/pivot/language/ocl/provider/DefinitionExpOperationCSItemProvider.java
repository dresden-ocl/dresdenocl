 ...
 * {@link tudresden.ocl20.pivot.language.ocl.DefinitionExpOperationCS} object.
...
public class DefinitionExpOperationCSItemProvider extends
	...
	protected void addEqualPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DefinitionExpOperationCS_equal_feature",
						"_UI_DefinitionExpOperationCS_type"),
				OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__EQUAL, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OPERATION);
			childrenFeatures
					.add(OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION);
		}
	...
	/**
	 * This returns DefinitionExpOperationCS.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/DefinitionExpOperationCS"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors
				.add(createChildParameter(
						...
						OclFactory.eINSTANCE
								.createEnumLiteralOrStaticPropertyExpCS()));
		...
		newChildDescriptors
				.add(createChildParameter(
						OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION,
						OclFactory.eINSTANCE
								.createPropertyCallExplicitPathExpCS()));
		...
		newChildDescriptors
				.add(createChildParameter(
						OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION,
						OclFactory.eINSTANCE
								.createLogicalNotOperationCallExpCS()));

		newChildDescriptors
				.add(createChildParameter(
						OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION,
						OclFactory.eINSTANCE
								.createOperationCallWithSourceExpCS()));
		...
		newChildDescriptors
				.add(createChildParameter(
						OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION,
						OclFactory.eINSTANCE
								.createRelationalOperationCallExpCS()));
		...
		newChildDescriptors
				.add(createChildParameter(
						OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION,
						OclFactory.eINSTANCE
								.createLogicalAndOperationCallExpCS()));

		newChildDescriptors
				.add(createChildParameter(
						OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION,
						OclFactory.eINSTANCE
								.createLogicalOrOperationCallExpCS()));

		newChildDescriptors
				.add(createChildParameter(
						OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION,
						OclFactory.eINSTANCE
								.createLogicalXorOperationCallExpCS()));

		newChildDescriptors
				.add(createChildParameter(
						OclPackage.Literals.DEFINITION_EXP_OPERATION_CS__OCL_EXPRESSION,
						OclFactory.eINSTANCE
								.createLogicalImpliesOperationCallExpCS()));
