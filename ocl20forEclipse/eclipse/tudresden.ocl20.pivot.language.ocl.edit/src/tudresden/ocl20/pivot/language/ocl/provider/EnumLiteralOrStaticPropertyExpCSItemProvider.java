 ...
 * {@link tudresden.ocl20.pivot.language.ocl.EnumLiteralOrStaticPropertyExpCS}
...
public class EnumLiteralOrStaticPropertyExpCSItemProvider extends
	...
	/**
	 * This adds a property descriptor for the Enum Literal Or Static Property
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_EnumLiteralOrStaticPropertyExpCS_enumLiteralOrStaticProperty_feature",
								"_UI_EnumLiteralOrStaticPropertyExpCS_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(OclPackage.Literals.ENUM_LITERAL_OR_STATIC_PROPERTY_EXP_CS__TYPE_NAME);
		}
	...
	/**
	 * This returns EnumLiteralOrStaticPropertyExpCS.gif. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/EnumLiteralOrStaticPropertyExpCS"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification
				.getFeatureID(EnumLiteralOrStaticPropertyExpCS.class)) {
