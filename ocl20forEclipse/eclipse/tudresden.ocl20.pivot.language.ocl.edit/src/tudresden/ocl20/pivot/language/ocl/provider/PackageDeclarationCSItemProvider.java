 ...
 * {@link tudresden.ocl20.pivot.language.ocl.PackageDeclarationCS} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PackageDeclarationCSItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public PackageDeclarationCSItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PackageDeclarationCS_layoutInformation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PackageDeclarationCS_layoutInformation_feature", "_UI_PackageDeclarationCS_type"),
				 OclPackage.Literals.PACKAGE_DECLARATION_CS__LAYOUT_INFORMATION,
				 true,
				 false,
				 true,
				 null,
