...
(SELECT * FROM OVO_Car AS self
WHERE NOT (((SELECT IFNULL(COUNT(temp7.PK_Car IN
  (temp1.PK_Car)),0)
FROM OVO_Car AS temp1
INNER JOIN ASO_ownedCars_owner AS temp2 ON temp1.PK_Car = temp2.FK_ownedCars
INNER JOIN OVO_Person AS temp3 ON temp2.FK_owner = temp3.PK_Person
...
WHERE NOT(temp1.PK_Car IN
  ((SELECT temp8.PK_Car
FROM OVO_Car AS temp8
INNER JOIN ASO_ownedCars_owner AS temp9 ON temp8.PK_Car = temp9.FK_ownedCars
INNER JOIN OVO_Person AS temp10 ON temp9.FK_owner = temp10.PK_Person
INNER JOIN OVO_Person AS temp11 ON temp10.PK_Person = temp11.PK_Person
INNER JOIN ASO_ownedCars_owner AS temp12 ON temp11.PK_Person = temp12.FK_owner
INNER JOIN OVO_Car AS temp13 ON temp12.FK_ownedCars = temp13.PK_Car
 WHERE temp13.PK_Car = temp1.PK_Car)))))));
...
INNER JOIN ASO_ownedCars_owner AS temp12 ON temp11.PK_Person = temp12.FK_owner
INNER JOIN OVO_Car AS temp13 ON temp12.FK_ownedCars = temp13.PK_Car
 WHERE temp13.PK_Car = temp1.PK_Car))) = VALUESTMT)));
...
(SELECT * FROM OVO_Car AS self
WHERE NOT (((SELECT IFNULL(SUM(IF(temp1.PK_Car IS NULL,NULL,1)),0)
FROM OVO_Car AS temp1
INNER JOIN ASO_ownedCars_owner AS temp2 ON temp1.PK_Car = temp2.FK_ownedCars
INNER JOIN OVO_Person AS temp3 ON temp2.FK_owner = temp3.PK_Person
INNER JOIN OVO_Person AS temp4 ON temp3.PK_Person = temp4.PK_Person
