...
example at 
\code{https://dresden-ocl.svn.sourceforge.net/svnroot/dresden-ocl/trunk/ocl20forEclipse/\linebreak[0]stand\-a\-lone/\linebreak[0]tudresden.ocl20.pivot.standalone.example}.
