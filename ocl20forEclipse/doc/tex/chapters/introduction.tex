...
\eclipse{Package Explorer} and open the popup menu with a right mouse click on
it. Select the menu option \eclipse{DresdenOCL > Load 
Model}. In the opened wizard you have to select the meta-model \acs{UML}2 and
push the \eclipse{Finish} button (see Figure~\ref{pic:intro:loadmodel01}).
...
of the Simple Example in the \eclipse{Package Explorer}, open the popup menu 
on it and select the menu option \eclipse{DresdenOCL > Load Model Instance}.
