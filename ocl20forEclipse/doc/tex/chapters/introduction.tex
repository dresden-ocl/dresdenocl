...
Enter the path
\url{http://dresden-ocl.sourceforge.net/downloads/updatesite/site.xml} and press
the \eclipse{Add...} button (see Figure~\ref{pic:intro:updateSite01}). In the
new opened window you can additionaly enter a name for the update site (see
Figure~\ref{pic:intro:updateSite02}).
