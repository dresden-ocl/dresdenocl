Dresden OCL has been developed at the Technische Universität Dresden, Faculty of Computer Science, Software Technology Group. Dresden OCL and this manual are available a the Dresden OCL project website (\url{http://dresden-ocl.sourceforge.net/}).
...
We are always looking forward to find new projects that use Dresden OCL or at least parts of it. Thus, please inform us, if you use Dresden OCL in your project.
