...
The central regustry component of Dresden OCL is the \keyword{Model-Bus}
...
First, to load a model into Dresden OCL, the meta-model the model is an instance
...
the package
\code{tudresden.ocl20.pivot.language.ocl\linebreak[0].re\-source\linebreak[0].ocl}.
