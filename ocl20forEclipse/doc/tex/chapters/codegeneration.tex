...
\begin{figure}[!b]
	...
	\caption{The package explorer containing the newly generated aspect file.}
...
This Chapter described how to generate AspectJ code using the \keyword{OCL22Java} code generator of \acl{DOT4Eclipse}. A more detailed documentation of the OCL22Java code generator can be found in the Minor Thesis (Groﬂer Beleg) of Claas Wilke \cite{GB:Wilke}.