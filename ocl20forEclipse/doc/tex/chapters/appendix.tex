...
\end{tabular}
\caption{The plug-ins of Dresden OCL2 for Eclipse related to their feature (part 1).}
\label{tab:plugins}
\end{table}
...
\begin{tabular}{|p{4cm}|p{10cm}|}
    ...
    \hline
\end{tabular}
\caption{The plug-ins of Dresden OCL2 for Eclipse related to their feature (part 2).}
\end{table}
