...
\todomt{Is Table~\ref{tab:software} complete?}
...
\todomt{Revise Table~\ref{tab:plugins}. Add plug-ins for new OCL Parser/Editor
and remove old OCL Editor} 
\todocw{Add OCL22SQL to Table~\ref{tab:plugins} when available.}
...
\todocw{Add University example to Table~\ref{tab:examples} when OCL22SQL is
available.}
