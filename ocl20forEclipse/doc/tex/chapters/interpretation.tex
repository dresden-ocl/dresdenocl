...
select them in the \eclipse{Model Browser} (see 
Figure~\ref{pic:interpret:interpret03}) and push the \eclipse{Interpret} button.
...
We select the constraint in the \eclipse{Model Browser} (see 
Figure~\ref{pic:interpret:interpret06}) and push the \eclipse{Interpret} button.
