...
To run the extensible test suite, right-click on \code{OCL2TestSuiteRunner} in the package \code{tudresden.\linebreak[0]ocl20.pivot.testsuite.runner}. Choose \code{Run As} --\textgreater \code{JUnit Plug-in Test} as in figure \ref{pic:generalTestSuite:RunAs}.
