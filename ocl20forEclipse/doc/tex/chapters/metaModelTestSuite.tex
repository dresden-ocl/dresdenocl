...
This chapter shortly introduced into the generic meta-model test suite of \acs{DOT4Eclipse} for further details of the test suite investigate the test suite plug-in \code{tudresden.ocl20.pivot.metamodels.test} or the existing test suite instantiations in the plug-ins \code{tudresden.ocl20.pivot.metamodels.uml2.test} or \code{tudresden.ocl20.pivot.metamodels.ecore.test}.
