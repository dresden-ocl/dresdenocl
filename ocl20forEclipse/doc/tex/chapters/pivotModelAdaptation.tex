...
\begin{figure}[!htbp]
	...
	\caption{Create an annotation for the \model{ecore} package.}
...
\begin{figure}[!htbp]
	...
	\caption{The \eclipse{Properties View} for the annotation.}
...
\begin{figure}[!htbp]
	...
	\caption{The \eclipse{Properties View} for the annotation details.}
...
\begin{figure}[!htbp]
	...
	\caption{The \model{EClass} annotation.}
...
\begin{figure}[!htbp]
	...
	\caption{Right-click on \model{Ecore} and select \eclipse{Generate Pivot Model adapters}.}
