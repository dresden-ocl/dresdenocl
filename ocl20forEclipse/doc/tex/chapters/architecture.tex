...
As already said, the core feature of DresdenOCL is the \keyword{Pivot Model}
...
DresdenOCL contains a second model the \keyword{Model Instance Types}
...
DresdenOCL. The \keyword{Pivot Model} and the \keyword{Model Instance Types} 
