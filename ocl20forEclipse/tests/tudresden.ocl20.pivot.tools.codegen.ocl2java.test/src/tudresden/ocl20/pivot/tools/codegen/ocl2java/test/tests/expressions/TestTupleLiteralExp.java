 ...
 * @author Claas Wilke
 */
public class TestTupleLiteralExp extends AbstractDiffTest {
	 ...
	 */
	@Test
	public void testTuple01() throws Exception {

		this.compareFragmentCodeGeneration("expressions/literals", "tuple01");
	}
}