...
public class InterpretationResultCache {
     ...
     */
    private Set<IInterpretationResult> myCachedResults = new HashSet<IInterpretationResult>();
	...
	for (IInterpretationResult interpretationResult : this.myCachedResults) {
	    ...
	    /*
	     * Only save objects, that are not contained in the list of model
	     * instance elements and constraints.
	     */
     ...
     * <p>
     * Removes the {@link IInterpretationResult}s for a given {@link List} of
     * {@link Object}s that equal to the {@link IInterpretationResult} that
     * shall be deleted.
     * </p>
     * 
     * @param objects
