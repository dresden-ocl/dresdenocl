...
public class TestOclInvalid extends AbstractTracerTest {
	...
	public void testOclAsType01() throws Exception {
		...
		String constraintFilePath = CONSTRAINT_DIRECTORY + "oclinvalid/oclAsType01.ocl";
		...
		regressionFile =
				AbstractTracerTest.getFile(
						"resources/standardlibrary/oclAsType01_regression.xml",
						TracerTestPlugin.PLUGIN_ID);
	
		temporaryDocument = serializeTracerRoot(tracedRoot);

		/*
		File f = new File("resources/standardlibrary/oclAsType01_regression.xml");
