...
public class TestString extends AbstractTracerTest {
	...
	public void testGreaterThan01() throws Exception {
		...
		String constraintFilePath = CONSTRAINT_DIRECTORY + "string/greaterThan01.ocl";
		...
		regressionFile =
				AbstractTracerTest.getFile(
						"resources/standardlibrary/string01_regression.xml",
						TracerTestPlugin.PLUGIN_ID);
	
		temporaryDocument = serializeTracerRoot(tracedRoot);

		/*
		File f = new File("resources/standardlibrary/string01_regression.xml");
