...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tracer Root</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class TracerRootImpl extends EObjectImpl implements TracerRoot {
	...
	public EList<TracerItem> getRootItems() {
		if (rootItems == null) {
			rootItems = new EObjectResolvingEList<TracerItem>(TracerItem.class, this, TracermodelPackage.TRACER_ROOT__ROOT_ITEMS);
		}
		return rootItems;
	}
