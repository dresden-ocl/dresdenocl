...
public class TracermodelPackageImpl extends EPackageImpl implements
	...
	initEClass(tracerItemEClass, TracerItem.class, "TracerItem",
		!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEReference(getTracerItem_Expression(), ecorePackage.getEObject(),
		null, "expression", null, 0, 1, TracerItem.class,
		!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
		!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
		IS_ORDERED);
	initEAttribute(getTracerItem_Result(), this.getOclAny(), "result",
		null, 0, 1, TracerItem.class, !IS_TRANSIENT, !IS_VOLATILE,
		IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
		IS_ORDERED);
	initEReference(getTracerItem_Parent(), this.getTracerItem(), null,
		"parent", null, 0, 1, TracerItem.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getTracerItem_Children(), this.getTracerItem(), null,
		"children", null, 0, -1, TracerItem.class, !IS_TRANSIENT,
		!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
		!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	initEAttribute(getTracerItem_Guid(), this.getUUID(), "guid", null, 0,
		1, TracerItem.class, !IS_TRANSIENT, !IS_VOLATILE,
		IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
		IS_ORDERED);

	initEClass(tracerRootEClass, TracerRoot.class, "TracerRoot",
		!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	...
	initEDataType(uuidEDataType, java.util.UUID.class, "UUID",
