...
public class TracerItemItemProvider extends ItemProviderAdapter implements
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
		...
		getString("_UI_PropertyDescriptor_description",
			"_UI_TracerItem_children_feature",
			"_UI_TracerItem_type"),
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
		...
		getString("_UI_PropertyDescriptor_description",
			"_UI_TracerItem_guid_feature", "_UI_TracerItem_type"),
		TracermodelPackage.Literals.TRACER_ITEM__GUID, true, false,
	...
	return overlayImage(object,
		getResourceLocator().getImage("full/obj16/TracerItem"));
    }
