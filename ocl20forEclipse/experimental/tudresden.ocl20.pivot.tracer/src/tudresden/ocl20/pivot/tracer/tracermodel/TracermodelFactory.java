...
public interface TracermodelFactory extends EFactory {
     ...
     * @generated
     */
    TracermodelFactory eINSTANCE = tudresden.ocl20.pivot.tracer.tracermodel.impl.TracermodelFactoryImpl
	    .init();

    /**
     * Returns a new object of class '<em>Tracer Item</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Tracer Root</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
