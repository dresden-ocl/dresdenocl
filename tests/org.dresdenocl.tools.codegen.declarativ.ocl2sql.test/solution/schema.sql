...
PK_Facility VARCHAR(255),
type VARCHAR(255),
name VARCHAR(255),
FK_headOfFacility VARCHAR(255),
FK_superFacility VARCHAR(255)
);
...
wage INT,
FK_theFacility VARCHAR(255),
FK_supervisor VARCHAR(255)
);

CREATE TABLE T_Paper (
PK_Paper VARCHAR(255),
...
AS ( SELECT PK_Person,T_Person.age AS age,T_Person.birthDate AS birthDate,FK_currentPaper,T_Person.firstName AS firstName,FK_grade,T_Person.isMarried AS isMarried,T_Person.lastName AS lastName,T_Person.matDate AS matDate,T_Person.matNr AS matNr,T_Person.salaries AS salaries,FK_theFacility,FK_supervisor
FROM T_Person
WHERE type = "Student" );
...
AS ( SELECT PK_Person,T_Person.age AS age,T_Person.birthDate AS birthDate,FK_currentPaper,T_Person.firstName AS firstName,FK_grade,T_Person.isMarried AS isMarried,T_Person.lastName AS lastName,T_Person.salaries AS salaries,FK_theFacility,FK_supervisor
FROM T_Person
 );
...
AS ( SELECT PK_Person,T_Person.age AS age,T_Person.birthDate AS birthDate,FK_currentPaper,T_Person.firstName AS firstName,FK_grade,T_Person.isMarried AS isMarried,T_Person.lastName AS lastName,T_Person.salaries AS salaries,T_Person.soSecNr AS soSecNr,T_Person.taxClass AS taxClass,T_Person.wage AS wage,FK_theFacility,FK_supervisor
FROM T_Person
WHERE type = "Employee" );
...
AS ( SELECT PK_Person,T_Person.age AS age,T_Person.birthDate AS birthDate,FK_currentPaper,T_Person.dissSubject AS dissSubject,T_Person.firstName AS firstName,FK_grade,T_Person.isMarried AS isMarried,T_Person.lastName AS lastName,T_Person.salaries AS salaries,T_Person.soSecNr AS soSecNr,T_Person.taxClass AS taxClass,T_Person.wage AS wage,FK_theFacility,FK_supervisor
FROM T_Person
...
ALTER TABLE T_Grade ADD CONSTRAINT PK_Grade
PRIMARY KEY (PK_Grade);

ALTER TABLE T_Paper ADD CONSTRAINT PK_Paper
PRIMARY KEY (PK_Paper);

ALTER TABLE T_Facility ADD CONSTRAINT PK_Facility
