 ...
 * @author Claas Wilke
 */
public class TestBugFix02 extends AbstractXmlModelInstanceTest {
	...
	public void testLoadModel() throws Exception {
		...
		File modelFile;
		modelFile = TestBugFix02.getFile("model/bugfix02.xsd");
		...
		modelInstanceFile = TestBugFix02.getFile("modelinstance/bugfix02.xml");
