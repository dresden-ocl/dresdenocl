 ...
 * @author Claas Wilke
 */
public class TestOperationCallExp {
	 ...
	 */
	@Test
	public void testOperationCallExp01() {

		Class1 class1;
		class1 = new Class1();

		assertEquals(class1.getInteger(), class1.testOperationCallExp01());
	}
	 ...
	 */
	@Test
	public void testOperationCallExp02() {

		Class1 class1;
		class1 = new Class1();

		assertEquals(Class1.getStaticInteger(), class1.testOperationCallExp02());
	}
}
