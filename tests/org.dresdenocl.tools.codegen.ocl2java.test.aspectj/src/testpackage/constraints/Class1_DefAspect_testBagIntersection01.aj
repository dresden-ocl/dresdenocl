...
public privileged aspect Class1_DefAspect_testBagIntersection01 {
     ...
     * <code>context Class1
     *       def: testBagIntersection01(source: Bag(OclAny), arg01: Set(OclAny)): Bag(OclAny) = source ->intersection(arg01)</code></p>
     */
    public java.util.List<Object> testpackage.Class1.testBagIntersection01(java.util.List<Object> source, java.util.Set<Object> arg01) {
        return org.dresdenocl.tools.codegen.ocl2java.types.util.OclBags.intersection(source, arg01);
    }
}