...
public privileged aspect Class1_DefAspect_testClosureIteratorExp03 {
     ...
     * <code>context Class1
     *       def: testClosureIteratorExp03() : OrderedSet(Class1) = self->asOrderedSet()->closure(parent)</code></p>
     */
    public java.util.List<testpackage.Class1> testpackage.Class1.testClosureIteratorExp03() {
        ...
        toVisit1.addAll(tudresden.ocl20.pivot.tools.codegen.ocl2java.types.util.OclSets.asOrderedSet(result2));
