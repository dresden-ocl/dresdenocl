...
public class TestBoolean extends AbstractTracerTest {
	...
	public void testAnd01() throws Exception {
		...
		String constraintFilePath = CONSTRAINT_DIRECTORY + "boolean/and01.ocl";
		...
		regressionFile =
				AbstractTracerTest.getFile(
						"resources/standardlibrary/and01_regression.xml",
						TracerTestPlugin.PLUGIN_ID);
	
		temporaryDocument = serializeTracerRoot(tracedRoot);
	
		/*
		File f = new File("resources/standardlibrary/and01_regression.xml");
