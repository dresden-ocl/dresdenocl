 ...
 * @author Claas Wilke
 */
public class TestBooleanLiteralExp extends AbstractDiffTest {
	...
	public void testBoolean01() throws Exception {
		...
		this.compareFragmentCodeGeneration("expressions/literals", "boolean01");
	}
	...
	public void testBoolean02() throws Exception {
		...
		this.compareFragmentCodeGeneration("expressions/literals", "boolean02");
	}
}