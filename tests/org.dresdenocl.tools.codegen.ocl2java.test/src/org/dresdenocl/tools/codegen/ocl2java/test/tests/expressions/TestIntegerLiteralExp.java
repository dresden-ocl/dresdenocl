 ...
 * @author Claas Wilke
 */
public class TestIntegerLiteralExp extends AbstractDiffTest {
	 ...
	 */
	@Test
	public void testInteger01() throws Exception {

		this.compareFragmentCodeGeneration("expressions/literals", "integer01");
	}
}