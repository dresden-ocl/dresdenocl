 ...
 * @author Claas Wilke
 */
public class TestOperationCallExp extends AbstractDiffTest {
	 ...
	 */
	@Test
	public void testOperation01() throws Exception {

		this.compareFragmentCodeGeneration("expressions/calls", "operation01");
	}
	 ...
	 */
	@Test
	public void testOperation02() throws Exception {

		this.compareFragmentCodeGeneration("expressions/calls", "operation02");
	}
}