...
public privileged aspect CustomerCard_InvAspect1 {
    ...
    declare parents: org.dresdenocl.examples.royalandloyal.CustomerCard implements org.dresdenocl.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.examples.royalandloyal.CustomerCard.checkInvariants() {
        /* Remains empty. Is only filled with behavior by advice(s). */
    }

    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.examples.royalandloyal.CustomerCard#checkInvariants()}.</p>
     */
    protected pointcut checkInvariantsCaller(org.dresdenocl.examples.royalandloyal.CustomerCard aClass):
     ...
     */
    after(org.dresdenocl.examples.royalandloyal.CustomerCard aClass) : checkInvariantsCaller(aClass) {
