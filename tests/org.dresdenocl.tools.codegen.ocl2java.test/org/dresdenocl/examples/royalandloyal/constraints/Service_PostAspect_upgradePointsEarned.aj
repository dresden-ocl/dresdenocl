...
public privileged aspect Service_PostAspect_upgradePointsEarned {
    ...
    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.examples.royalandloyal.Service#upgradePointsEarned(Integer amount)}.</p>
     */
    protected pointcut upgradePointsEarnedCaller(org.dresdenocl.examples.royalandloyal.Service aClass, Integer amount):
    	call(* org.dresdenocl.examples.royalandloyal.Service.upgradePointsEarned(Integer))
     ...
     */
    void around(org.dresdenocl.examples.royalandloyal.Service aClass, Integer amount): upgradePointsEarnedCaller(aClass, amount) {
