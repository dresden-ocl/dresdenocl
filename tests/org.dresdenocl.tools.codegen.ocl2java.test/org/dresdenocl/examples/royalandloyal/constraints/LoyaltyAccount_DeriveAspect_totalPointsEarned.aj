...
public privileged aspect LoyaltyAccount_DeriveAspect_totalPointsEarned {
    ...
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.examples.royalandloyal.LoyaltyAccount#totalPointsEarned}.</p>
     */
    protected pointcut totalPointsEarnedGetter(org.dresdenocl.examples.royalandloyal.LoyaltyAccount aClass) :
     ...
     */
    before(org.dresdenocl.examples.royalandloyal.LoyaltyAccount aClass): totalPointsEarnedGetter(aClass) {
        ...
        for (org.dresdenocl.examples.royalandloyal.Transaction anElement1 : aClass.transactions) {
            if (anElement1.getClass().getCanonicalName().equals(org.dresdenocl.examples.royalandloyal.Earning.class.getCanonicalName())) {
