...
public privileged aspect Customer_InvAspect_ofAge {
    ...
    /**
     * <p>Describes all public methods of the class {@link org.dresdenocl.examples.royalandloyal.Customer}.</p>
     */
    protected pointcut allCustomerPublicMethods(org.dresdenocl.examples.royalandloyal.Customer aClass):
        execution(public * org.dresdenocl.examples.royalandloyal.Customer.*(..)) && this(aClass);
     ...
     */
    before(org.dresdenocl.examples.royalandloyal.Customer aClass) : allCustomerPublicMethods(aClass) {
     ...
     */
    after(org.dresdenocl.examples.royalandloyal.Customer aClass) : allCustomerConstructors(aClass) || allCustomerPublicMethods(aClass) {
        /* Disable this constraint for subclasses of Customer. */
        if (aClass.getClass().getCanonicalName().equals("org.dresdenocl.examples.royalandloyal.Customer")) {
        if (!(aClass.age >= new Integer(18))) {
        	// TODO Auto-generated code executed when constraint is violated.
     ...
     */
    after(org.dresdenocl.examples.royalandloyal.Customer aClass) throwing : allCustomerPublicMethods(aClass) {
        /* Disable this constraint for subclasses of Customer. */
        if (aClass.getClass().getCanonicalName().equals("org.dresdenocl.examples.royalandloyal.Customer")) {
        if (!(aClass.age >= new Integer(18))) {
        	// TODO Auto-generated code executed when constraint is violated.
