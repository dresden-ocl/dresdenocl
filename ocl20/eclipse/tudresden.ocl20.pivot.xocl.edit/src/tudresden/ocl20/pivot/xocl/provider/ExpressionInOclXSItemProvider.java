...
/**
 * This is the item provider adapter for a {@link tudresden.ocl20.pivot.xocl.ExpressionInOclXS} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionInOclXSItemProvider extends ItemProviderAdapter implements
   ...
   * @generated
   */
  public ExpressionInOclXSItemProvider(AdapterFactory adapterFactory) {
  ...
  /**
   * This returns ExpressionInOclXS.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
   ...
   * 
   * <p>
   * Adapted the EMF implementation to simply show the expression body.
   * </p>
   * 
   * @generated NOT
   */
  ...
  public String getText(Object object) {
    String label = ((ExpressionInOclXS) object).getBody();
    return label == null || label.length() == 0 ? "undefined body" : label; //$NON-NLS-1$
  }
