...
/**
 * This is the item provider adapter for a {@link tudresden.ocl20.pivot.xocl.UnlimitedNaturalExpXS} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnlimitedNaturalExpXSItemProvider extends
   ...
   * @generated
   */
  public UnlimitedNaturalExpXSItemProvider(AdapterFactory adapterFactory) {
  ...
  /**
   * This returns UnlimitedNaturalExpXS.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  public String getText(Object object) {
    String label = ((UnlimitedNaturalExpXS) object).getSymbol();
    return label == null || label.length() == 0 ? getString("_UI_UnlimitedNaturalExpXS_type") : //$NON-NLS-1$
        getString("_UI_UnlimitedNaturalExpXS_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
