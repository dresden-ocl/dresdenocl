...
/**
 * This is the item provider adapter for a {@link tudresden.ocl20.pivot.xocl.NamespaceXS} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamespaceXSItemProvider extends ItemProviderAdapter implements
   ...
   * @generated
   */
  public NamespaceXSItemProvider(AdapterFactory adapterFactory) {
  ...
  public String getText(Object object) {
    String label = ((NamespaceXS) object).getPathName();
    return label == null || label.length() == 0 ? "package" : "package " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
