...
public class PMLPackageImpl extends EPackageImpl implements PMLPackage {
  ...
  public static PMLPackage init() {
    ...
    PMLPackageImpl thePMLPackage = (PMLPackageImpl) (EPackage.Registry.INSTANCE
        ...
        .getEPackage(eNS_URI) : new PMLPackageImpl());
  ...
  public void initializePackageContents() {
    ...
    initEClass(pluginEClass,Plugin.class,
    ...
    initEClass(javaTypeEClass,JavaType.class,
    ...
    initEClass(serviceParameterEClass,ServiceParameter.class,
