...
public interface Plugin extends EObject {
   ...
   * @model type="tudresden.ocl20.pivot.examples.pml.ExtensionPoint" opposite="plugin" containment="true"
   * @generated
   */
   ...
   * @model type="tudresden.ocl20.pivot.examples.pml.Service" opposite="plugin" containment="true"
   * @generated
   */
