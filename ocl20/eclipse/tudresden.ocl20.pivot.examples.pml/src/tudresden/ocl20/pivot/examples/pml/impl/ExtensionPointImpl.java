...
public class ExtensionPointImpl extends EObjectImpl implements ExtensionPoint {
  ...
  public void setPlugin(Plugin newPlugin) {
    if (newPlugin != eInternalContainer()
      ...
      if (newPlugin != null)
        msgs = ((InternalEObject) newPlugin).eInverseAdd(this,PMLPackage.PLUGIN__EXTENSION_POINTS,
            Plugin.class,msgs);
      msgs = basicSetPlugin(newPlugin,msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PMLPackage.EXTENSION_POINT__PLUGIN,
          newPlugin,newPlugin));
  }
  ...
  public JavaType getType() {
    if (type != null && type.eIsProxy()) {
      ...
      if (type != oldType) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this,Notification.RESOLVE,PMLPackage.EXTENSION_POINT__TYPE,
              oldType,type));
      }
    }
    return type;
  ...
  public void setType(JavaType newType) {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PMLPackage.EXTENSION_POINT__TYPE,oldType,
          type));
  }
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
    switch (eContainerFeatureID) {
      case PMLPackage.EXTENSION_POINT__PLUGIN:
        return eInternalContainer().eInverseRemove(this,PMLPackage.PLUGIN__EXTENSION_POINTS,
            Plugin.class,msgs);
    }
