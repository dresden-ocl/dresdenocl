...
public class PluginImpl extends EObjectImpl implements Plugin {
   ...
   * @ordered
   */
  protected EList<Service> services = null;
   ...
   * @ordered
   */
  protected JavaType activator = null;
  ...
  public void setVersion(String newVersion) {
    ...
    version = newVersion;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PMLPackage.PLUGIN__VERSION,oldVersion,
          version));
  }
  ...
  public void setProvider(String newProvider) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PMLPackage.PLUGIN__PROVIDER,oldProvider,
          provider));
  }
  ...
  public void setFeature(Feature newFeature) {
    if (newFeature != eInternalContainer()
      ...
      if (newFeature != null)
        msgs = ((InternalEObject) newFeature).eInverseAdd(this,PMLPackage.FEATURE__PLUGINS,
            Feature.class,msgs);
      msgs = basicSetFeature(newFeature,msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PMLPackage.PLUGIN__FEATURE,newFeature,
          newFeature));
  }
  ...
  public EList<Service> getServices() {
    if (services == null) {
      services = new EObjectContainmentWithInverseEList<Service>(Service.class,this,
          PMLPackage.PLUGIN__SERVICES,PMLPackage.SERVICE__PLUGIN);
    }
    return services;
  }
  ...
  public JavaType getActivator() {
    if (activator != null && activator.eIsProxy()) {
      ...
      if (activator != oldActivator) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this,Notification.RESOLVE,PMLPackage.PLUGIN__ACTIVATOR,
  ...
  public void setActivator(JavaType newActivator) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PMLPackage.PLUGIN__ACTIVATOR,
          oldActivator,activator));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
    ...
    switch (featureID) {
      ...
      case PMLPackage.PLUGIN__EXTENSION_POINTS:
        return ((InternalEList<InternalEObject>) (InternalEList<?>) getExtensionPoints()).basicAdd(
            otherEnd,msgs);
      case PMLPackage.PLUGIN__SERVICES:
        return ((InternalEList<InternalEObject>) (InternalEList<?>) getServices()).basicAdd(
            otherEnd,msgs);
    }
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
    switch (eContainerFeatureID) {
      case PMLPackage.PLUGIN__FEATURE:
        return eInternalContainer().eInverseRemove(this,PMLPackage.FEATURE__PLUGINS,Feature.class,
            msgs);
    }
