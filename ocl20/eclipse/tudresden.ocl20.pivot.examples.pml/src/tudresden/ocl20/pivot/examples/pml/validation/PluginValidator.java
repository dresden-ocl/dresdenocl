 ...
 * $Id$
 */
package tudresden.ocl20.pivot.examples.pml.validation;
...
/**
 * A sample validator interface for {@link tudresden.ocl20.pivot.examples.pml.Plugin}.
...
public interface PluginValidator {
	...
	boolean validateExtensionPoints(EList<ExtensionPoint> value);

	boolean validateServices(EList<Service> value);

	boolean validateActivator(JavaType value);

	boolean validateValue(SampleEnum value);
}
