...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Collection Kind XS</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see tudresden.ocl20.pivot.xocl.XOCLPackage#getCollectionKindXS()
 * @model
 * @generated
 */
public enum CollectionKindXS implements Enumerator {
  /**
  ...
  /**
   * An array of all the '<em><b>Collection Kind XS</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
   ...
   * @generated
   */
  public static CollectionKindXS get(String literal) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      CollectionKindXS result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Collection Kind XS</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static CollectionKindXS getByName(String name) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      CollectionKindXS result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Collection Kind XS</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static CollectionKindXS get(int value) {
    switch (value) {
      case SET_VALUE:
        return SET;
   ...
   * @generated
   */
  private CollectionKindXS(int value, String name, String literal) {
    this.value = value;
    this.name = name;
