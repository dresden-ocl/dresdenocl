...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Collection Literal Exp XS</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link tudresden.ocl20.pivot.xocl.impl.CollectionLiteralExpXSImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link tudresden.ocl20.pivot.xocl.impl.CollectionLiteralExpXSImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionLiteralExpXSImpl extends LiteralExpXSImpl implements
   ...
   * @ordered
   */
  protected static final CollectionKindXS KIND_EDEFAULT = CollectionKindXS.SET;
   ...
   * @ordered
   */
  protected CollectionKindXS kind = KIND_EDEFAULT;
   ...
   * @generated
   */
  protected CollectionLiteralExpXSImpl() {
    super();
  }
  ...
  protected EClass eStaticClass() {
    return XOCLPackage.Literals.COLLECTION_LITERAL_EXP_XS;
  }
   ...
   * @generated
   */
  public CollectionKindXS getKind() {
    return kind;
  }
   ...
   * @generated
   */
  public void setKind(CollectionKindXS newKind) {
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      case XOCLPackage.COLLECTION_LITERAL_EXP_XS__KIND:
        setKind((CollectionKindXS) newValue);
        return;
      case XOCLPackage.COLLECTION_LITERAL_EXP_XS__PART:
        getPart().clear();
        getPart().addAll(
