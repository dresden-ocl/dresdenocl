...
public enum ConstraintKind implements InternalConstraintKind {
   ...
   * @generated
   */
  private static final ConstraintKind[] VALUES_ARRAY = new ConstraintKind[] { INVARIANT,
      DEFINITION, PRECONDITION, POSTCONDITION, INITIAL, DERIVED, BODY, };
   ...
   * @generated
   */
  public static final List<ConstraintKind> VALUES = Collections.unmodifiableList(Arrays
      .asList(VALUES_ARRAY));
