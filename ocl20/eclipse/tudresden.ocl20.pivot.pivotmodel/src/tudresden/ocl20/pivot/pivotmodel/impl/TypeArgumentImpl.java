...
public class TypeArgumentImpl extends TypedElementImpl implements TypeArgument {
  ...
  protected EClass eStaticClass() {
    return PivotModelPackageImpl.Literals.TYPE_ARGUMENT;
  }
  ...
  public String getName() {
    return getType() != null ? getType().getName() : (getGenericType() != null ? getGenericType()
        .getName() : ""); //$NON-NLS-1$
  }
  ...
  public void setName(String newName) {
    throw new UnsupportedOperationException("The name of a type argument cannot be changed."); //$NON-NLS-1$
  }
  ...
  public TypeArgument clone() {
    return (TypeArgument) initialize(PivotModelFactory.INSTANCE.createTypeArgument());
  }
  ...
  public NotificationChain basicSetOwningGenericType(ComplexGenericType newOwningGenericType,
    ...
    msgs = eBasicSetContainer((InternalEObject) newOwningGenericType,
        PivotModelPackageImpl.TYPE_ARGUMENT__OWNING_GENERIC_TYPE,msgs);
    return msgs;
  }
  ...
  public void setOwningGenericType(ComplexGenericType newOwningGenericType) {
    if (newOwningGenericType != eInternalContainer()
      ...
      if (newOwningGenericType != null)
        msgs = ((InternalEObject) newOwningGenericType)
            .eInverseAdd(this,PivotModelPackageImpl.COMPLEX_GENERIC_TYPE__TYPE_ARGUMENT,
      ...
      eNotify(new ENotificationImpl(this,Notification.SET,
          PivotModelPackageImpl.TYPE_ARGUMENT__OWNING_GENERIC_TYPE,newOwningGenericType,
          newOwningGenericType));
  }
    ...
    switch (eContainerFeatureID) {
      case PivotModelPackageImpl.TYPE_ARGUMENT__OWNING_GENERIC_TYPE:
        return eInternalContainer()
            .eInverseRemove(this,PivotModelPackageImpl.COMPLEX_GENERIC_TYPE__TYPE_ARGUMENT,
                ComplexGenericType.class,msgs);
    }
