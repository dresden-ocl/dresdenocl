...
public enum ParameterDirectionKind implements InternalParameterDirectionKind {
   ...
   * @generated
   */
  private static final ParameterDirectionKind[] VALUES_ARRAY = new ParameterDirectionKind[] { IN,
      OUT, INOUT, RETURN, };
   ...
   * @generated
   */
  public static final List<ParameterDirectionKind> VALUES = Collections.unmodifiableList(Arrays
      .asList(VALUES_ARRAY));
 ...
 * @generated
 */
interface InternalParameterDirectionKind extends org.eclipse.emf.common.util.Enumerator {
  // Empty 
}
