...
public class ParameterImpl extends TypedElementImpl implements Parameter {
    ...
    if (kind == ParameterDirectionKind.RETURN) {
      ...
      if (operation != null) {
        ...
        if ((operationGenericType == null && newGenericType != null)
            || (operationGenericType != null && !operationGenericType.equals(newGenericType))) {
  ...
  public void setOrdered(boolean newOrdered) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PivotModelPackageImpl.PARAMETER__ORDERED,
          oldOrdered,ordered));
  }
  ...
  public void setUnique(boolean newUnique) {
    ...
    unique = newUnique;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PivotModelPackageImpl.PARAMETER__UNIQUE,
          oldUnique,unique));
  }
  ...
  public void setKind(ParameterDirectionKind newKind) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,PivotModelPackageImpl.PARAMETER__KIND,
          oldKind,kind));
  }
  ...
  public Operation getOperation() {
    if (eContainerFeatureID != PivotModelPackageImpl.PARAMETER__OPERATION) return null;
    ...
    if (newOperation != eInternalContainer()
      ...
      if (newOperation != null)
        msgs = ((InternalEObject) newOperation).eInverseAdd(this,
            PivotModelPackageImpl.OPERATION__OWNED_PARAMETER,Operation.class,msgs);
      msgs = basicSetOperation(newOperation,msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this,Notification.SET,
          PivotModelPackageImpl.PARAMETER__OPERATION,newOperation,newOperation));
  }
