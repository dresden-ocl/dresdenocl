...
public enum PrimitiveTypeKind implements InternalPrimitiveTypeKind {
  ...
  /**
   * An array of all the '<em><b>Primitive Type Kind</b></em>' enumerators. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
   * @generated
   */
  private static final PrimitiveTypeKind[] VALUES_ARRAY = new PrimitiveTypeKind[] { UNKNOWN,
   ...
   * @generated
   */
  public static final List<PrimitiveTypeKind> VALUES = Collections.unmodifiableList(Arrays
      .asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Primitive Type Kind</b></em>' literal with the specified literal
  ...
  /**
   * Returns the '<em><b>Primitive Type Kind</b></em>' literal with the specified integer
   * value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
 ...
 * @generated
 */
interface InternalPrimitiveTypeKind extends org.eclipse.emf.common.util.Enumerator {
  // Empty
}
