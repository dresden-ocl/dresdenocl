...
/**
 * This is the item provider adapter for a {@link tudresden.ocl20.pivot.essentialocl.expressions.TupleLiteralPart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TupleLiteralPartItemProvider extends TypedElementItemProvider implements
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(ExpressionsPackageImpl.Literals.TUPLE_LITERAL_PART__PROPERTY);
      childrenFeatures.add(ExpressionsPackageImpl.Literals.TUPLE_LITERAL_PART__VALUE);
    }
  ...
  protected void collectNewChildDescriptors(Collection<CommandParameter> newChildDescriptors,
    ...
    newChildDescriptors.add(createChildParameter(
        ExpressionsPackageImpl.Literals.TUPLE_LITERAL_PART__PROPERTY,PivotModelFactory.INSTANCE
            .createProperty()));

    newChildDescriptors.add(createChildParameter(
        ExpressionsPackageImpl.Literals.TUPLE_LITERAL_PART__VALUE,ExpressionsFactory.INSTANCE
            .createVariableExp()));
