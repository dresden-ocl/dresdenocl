...
import tudresden.ocl20.pivot.pivotmodel.provider.ExpressionItemProvider;

/**
 * This is the item provider adapter for a {@link tudresden.ocl20.pivot.essentialocl.expressions.ExpressionInOcl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionInOclItemProvider extends ExpressionItemProvider implements
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__BODY_EXPRESSION);
      childrenFeatures.add(ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__CONTEXT);
      childrenFeatures.add(ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__RESULT);
      childrenFeatures.add(ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__PARAMETER);
    }
  ...
  protected void collectNewChildDescriptors(Collection<CommandParameter> newChildDescriptors,
    ...
    newChildDescriptors.add(createChildParameter(
        ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__BODY_EXPRESSION,
    ...
    newChildDescriptors.add(createChildParameter(
        ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__CONTEXT,ExpressionsFactory.INSTANCE
            .createVariable()));

    newChildDescriptors.add(createChildParameter(
        ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__RESULT,ExpressionsFactory.INSTANCE
            .createVariable()));

    newChildDescriptors.add(createChildParameter(
        ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__PARAMETER,ExpressionsFactory.INSTANCE
            .createVariable()));
  }
  ...
  public String getCreateChildText(Object owner, Object feature, Object child,
    ...
    boolean qualify = childFeature == ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__CONTEXT
        || childFeature == ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__RESULT
        || childFeature == ExpressionsPackageImpl.Literals.EXPRESSION_IN_OCL__PARAMETER;
