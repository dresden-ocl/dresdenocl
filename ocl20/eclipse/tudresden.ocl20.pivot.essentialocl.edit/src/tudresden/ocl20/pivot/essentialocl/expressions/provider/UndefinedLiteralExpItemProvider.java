 ...
 * @generated
 */
public class UndefinedLiteralExpItemProvider extends LiteralExpItemProvider implements
  ...
  public Object getImage(Object object) {
    return overlayImage(object,getResourceLocator().getImage("full/obj16/UndefinedLiteralExp")); //$NON-NLS-1$
  }
  ...
  public String getText(Object object) {
    String label = ((UndefinedLiteralExp) object).getName();
    return label == null || label.length() == 0 ? getString("_UI_UndefinedLiteralExp_type") : //$NON-NLS-1$
        getString("_UI_UndefinedLiteralExp_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
