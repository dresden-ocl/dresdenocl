...
public class LoopExpItemProvider extends CallExpItemProvider implements IEditingDomainItemProvider,
  ...
  protected void collectNewChildDescriptors(Collection<CommandParameter> newChildDescriptors,
    ...
    newChildDescriptors.add(createChildParameter(ExpressionsPackageImpl.Literals.LOOP_EXP__BODY,
    ...
    newChildDescriptors.add(createChildParameter(
        ExpressionsPackageImpl.Literals.LOOP_EXP__ITERATOR,ExpressionsFactory.INSTANCE
            .createVariable()));
  }
