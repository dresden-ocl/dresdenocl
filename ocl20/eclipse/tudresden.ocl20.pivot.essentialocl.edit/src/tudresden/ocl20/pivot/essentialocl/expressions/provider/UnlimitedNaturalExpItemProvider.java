 ...
 * @generated
 */
public class UnlimitedNaturalExpItemProvider extends NumericLiteralExpItemProvider implements
  ...
  protected void addSymbolPropertyDescriptor(Object object) {
    itemPropertyDescriptors
        .add(createItemPropertyDescriptor(
            ...
            getResourceLocator(),
            getString("_UI_UnlimitedNaturalExp_symbol_feature"), //$NON-NLS-1$
            getString(
            ...
            ExpressionsPackageImpl.Literals.UNLIMITED_NATURAL_EXP__SYMBOL,true,false,false,
  ...
  public Object getImage(Object object) {
    return overlayImage(object,getResourceLocator().getImage("full/obj16/UnlimitedNaturalExp")); //$NON-NLS-1$
  }
  ...
  public String getText(Object object) {
    ...
    return label == null || label.length() == 0 ? getString("_UI_UnlimitedNaturalExp_type") : //$NON-NLS-1$
        getString("_UI_UnlimitedNaturalExp_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
