...
public class EnumerationItemProvider extends TypeItemProvider implements
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(PivotModelPackageImpl.Literals.ENUMERATION__OWNED_LITERAL);
    }
  ...
  protected void collectNewChildDescriptors(Collection<CommandParameter> newChildDescriptors,
    ...
    newChildDescriptors.add(createChildParameter(
        PivotModelPackageImpl.Literals.ENUMERATION__OWNED_LITERAL,PivotModelFactory.INSTANCE
