...
package tudresden.ocl20.codegen.decl.mapping;
...
public class Guide {
	...
	/** 
	 * Alias for the context alias of the MappedClass in the target model, should be null if not used
	 */
	 ...
	 * 
	 * @param navigation true if the guide describes a navigation, false otherwise
	 * @param contextAlias the context alias of the MappedClass to start from
	 */
	 ...
	 * 
	 * @param contextAlias the context alias
	 */
