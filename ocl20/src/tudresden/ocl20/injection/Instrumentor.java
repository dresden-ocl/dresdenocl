...
import tudresden.ocl20.injection.lib.WrapperDummy;
  ...
  private String m_sFileDocComment = null;
	...
	throws IOException, InjectorParseException
	{
		if(!clean && !jc.isInterface())
		{
			...
			writeChangedChecker();
			// added by Ronny Brandt for supporting static features
      writeStaticChangedChecker();
			for(int j=0; j<class_state.taskInstrumentors.length; j++)
	...
	{
		if(clean ||
	  //removed by Ronny Brandt for supporting static features
		//jb.isStatic() ||
		jb.isAbstract() ||
	...
	// added by Ronny Brandt for supporting static features
	public static final String STATIC_CHANGED_CHECKER="checkForChangedStaticFeatures";
	...
	// added by Ronny Brandt for supporting static features
	private final void writeStaticChangedCheckerCall()
	throws IOException
	{
		Writer o=output;
		
		o.write(STATIC_CHANGED_CHECKER);
		o.write("();");
		o.write(lineSeparator);
	}
	
  // added by Ronny Brandt for supporting static features
	private final void writeStaticChangedChecker()
	throws IOException, InjectorParseException
	{
		Writer o=output;
