 ...
 * @author  Stefan Ocke
 */
public class OclModelException extends java.lang.Exception {
    
    /**
     * Creates a new instance of <code>ModelException</code> without detail message.
     */
    public OclModelException() {
    }
     ...
     */
    public OclModelException(String msg) {
        super(msg);
    }
    
    public OclModelException(Exception encapsulatedException) {
