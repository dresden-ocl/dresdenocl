 ...
 */
public abstract class OclMessageTypeImpl extends ClassifierImpl implements OclMessageType{
       
    protected OclMessageTypeImpl(StorableObject storable) {
        super(storable);
    }
    
    //What about type conformance?
}
