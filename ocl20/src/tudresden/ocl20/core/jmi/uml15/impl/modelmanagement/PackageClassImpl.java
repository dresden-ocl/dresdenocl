 ...
 */
public abstract class PackageClassImpl extends ClassProxyHandler implements PackageClass{
    
    /** Creates a new instance of ModelClassImpl */
    protected PackageClassImpl(StorableClass storable) {
        super(storable);
    }
