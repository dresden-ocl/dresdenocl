 ...
 */
public abstract class OclLibraryClassImpl extends ClassProxyHandler implements OclLibraryClass{
    
    /** Creates a new instance of OclLibraryClassImpl */
    protected OclLibraryClassImpl(StorableClass storable) {
        super(storable);
    }
