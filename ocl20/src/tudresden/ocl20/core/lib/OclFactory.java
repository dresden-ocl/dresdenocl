...
//  public OclRoot getOclRepresentationFor(char c);
   ...
   *
   *  @return an object of a type describeb by targetType
   */
  public Object reconvert(NonOclType targetType, OclRoot oclObject);
  
  /** re-transform an operation argument into an object of an application type; an
   *  implementing class should consider the direction kind of the parameter as well. 
   *
   *  @return an object of a type describeb by targetType
   */
  ...
  public OclModelType getOclModelTypeFor(String pathname);
