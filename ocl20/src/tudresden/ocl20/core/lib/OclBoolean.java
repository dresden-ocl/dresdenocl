 ...
 * 
 * class exist: <CODE>TRUE</CODE> and <CODE>FALSE</CODE>. This is a
 * slightly
 * 
 ...
 * 
 * <p>
 * TRUE and FALSE (in capital letters) in this documentation page denote the
 * 
...
public class OclBoolean extends OclAny {
	...
	/**
	 * <p>Constructs an instance representing an undefined <code>OclBoolean</code>.</p>
	 * 
	 * <p>This Constructor is deprecated. To create an undefined <code>OclBoolean</code> use
	 * Construtor <code>protected OclBoolean(String undefinedreason)</code></p>
	 * 
	 * @param dummy Must be 0.
	 * @param undefinedreason The reason why the <code>OclBoolean</code> is undefined.
	 * @deprecated <p>This Constructor is deprecated. To create an undefined <code>OclBoolean</code> 
	 * use Construtor <code>protected OclBoolean(String undefinedreason)</code></p>
	 */
	...
	public OclBoolean(String undefinedreason) {
	...
	public boolean isTrue() {
		...
		if (isUndefined()) {
			...
			throw new OclException(
					"tried to evaluate undefined OclBoolean value: "
							+ getUndefinedReason());
