...
/**
 * Describes a class from the model.
 * @author  Stefan Ocke
 */
public abstract class OclModelType extends OclType {
    
    protected OclFactory factory;
    /** Creates a new instance of OclModelType */
    public OclModelType(String name, OclFactory factory) {
        super(name);
...
//    /** Gets a feature of this modeltype. The OCL type of the result is determined by its Java Class.*/
...
//    
    ...
    public OclRoot getFeature(OclType type, String name){     
        ...
        if(or.isUndefined()){
            return new OclUndefined("feature "+name+" is null in "+this.getName());
        }
        return or;
    }
    
    abstract Object getFeatureImpl(String name);    
...
//    }
    ...
    abstract Object getFeatureImpl(String name, Object [] parameters);       
