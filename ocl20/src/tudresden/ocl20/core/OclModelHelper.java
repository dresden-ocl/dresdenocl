...
public class OclModelHelper {
    ...
    public EnumLiteralExp createEnumLiteral(String pathname){
        ...
        Enumeration enum= (Enumeration) model.getTopPackage().findClassifier(pathAsList);
        
        //find the literal
        EnumerationLiteral enumLit = null;
        Iterator literals = enum.getLiteralA().iterator();
        ...
        result.setType(enum);  //faster than calling the type evaluator
        return result;
    }
