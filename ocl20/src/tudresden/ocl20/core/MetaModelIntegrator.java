...
public class MetaModelIntegrator {
    ...
    static ModelPackage initOclMetaModel(final String name) throws Exception{
        ...
        String integratedxmi = java.net.URLDecoder.decode(mminfo.getIntegratedXmiPath().getPath()); //the pathname for the xmi document that represents the result of metamodel integration
        ...
        String generatedjmidirPath = java.net.URLDecoder.decode(ClassLoader.getSystemClassLoader().getResource(MetaModelConst.GENERATEDJMIDIR+java.io.File.separator).getPath());
