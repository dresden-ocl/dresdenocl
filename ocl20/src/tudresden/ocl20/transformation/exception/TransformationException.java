...
/**
 * The TransformationExcpetion is thrown, when an error occurs while running a metamodelbased transformation.
...
public class TransformationException extends Exception {
	 ...
	 * @param messageA helpful explanation why the exception was thrown
	 * @param impl The transformation in which the error occured.
	 */
