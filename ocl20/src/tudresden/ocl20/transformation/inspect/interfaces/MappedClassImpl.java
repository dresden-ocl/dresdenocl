...
/**
 * This is the implementation for the interface MappedClass. This implementation is
 * used by the Uml2MappedModel transformation to provide the information, that is needed
 * by the DeclarativeCodeGenerator to navigate in the target model.
 *
 * @author Christian Wende
 *
 */
public class MappedClassImpl implements MappedClass {

	private static final String NO_ATT_FOR_NAME = "There is no attribute for the given name.";
	private static final String NO_AEND_FOR_NAME = "There is no association end for the given name.";
	private static final String NO_CLASSGUIDE = "There is no classguide for this class.";
	 ...
	 * @param className The name for the MappedClass
	 */
	 ...
	 * @param g The guide, that should be added.
	 */
	...
	/**
	 * Adds the given guide as the attribute guide for the attribute with the given name.
	 * @param name The name of the attribute, the guide should be added for.
	 * @param guide The guide, that should be added.
	 */
	...
	/**
	 * Adds the given guide as the association end guide for the association end with the given name.
	 * @param name The name of the association end, the guide should be added for.
	 * @param guide The guide, that should be added.
	 */
