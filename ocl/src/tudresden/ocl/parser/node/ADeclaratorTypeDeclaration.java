...
public final class ADeclaratorTypeDeclaration extends PDeclaratorTypeDeclaration
{
    private TColon _colon_;
    private PSimpleTypeSpecifier _simpleTypeSpecifier_;

    public ADeclaratorTypeDeclaration()
    {
    }
    ...
    public Object clone()
    {
        return new ADeclaratorTypeDeclaration(
    ...
    {
        ((Analysis) sw).caseADeclaratorTypeDeclaration(this);
    }
