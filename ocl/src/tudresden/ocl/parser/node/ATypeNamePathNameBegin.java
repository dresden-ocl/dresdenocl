...
public final class ATypeNamePathNameBegin extends PPathNameBegin
{
    private PTypeName _typeName_;

    public ATypeNamePathNameBegin()
    {
    }
    ...
    public Object clone()
    {
        return new ATypeNamePathNameBegin(
            (PTypeName) cloneNode(_typeName_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATypeNamePathNameBegin(this);
    }
