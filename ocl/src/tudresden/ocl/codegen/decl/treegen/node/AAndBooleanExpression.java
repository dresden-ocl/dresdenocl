...
public final class AAndBooleanExpression extends PBooleanExpression
{
    private final LinkedList _booleanExpression_ = new TypedLinkedList(new BooleanExpression_Cast());

    public AAndBooleanExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AAndBooleanExpression(
            cloneList(_booleanExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAAndBooleanExpression(this);
    }
    ...
    private class BooleanExpression_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AAndBooleanExpression.this))
            {
