...
public final class APlusNumericExpression extends PNumericExpression
{
    private PNumericExpression _op1_;
    private PNumericExpression _op2_;

    public APlusNumericExpression()
    {
    }
    ...
    public Object clone()
    {
        return new APlusNumericExpression(
    ...
    {
        ((Analysis) sw).caseAPlusNumericExpression(this);
    }
