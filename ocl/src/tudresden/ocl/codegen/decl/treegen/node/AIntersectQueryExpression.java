...
public final class AIntersectQueryExpression extends PQueryExpression
{
    private TAll _all_;
    private final LinkedList _queryExpression_ = new TypedLinkedList(new QueryExpression_Cast());

    public AIntersectQueryExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AIntersectQueryExpression(
    ...
    {
        ((Analysis) sw).caseAIntersectQueryExpression(this);
    }
    ...
    private class QueryExpression_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AIntersectQueryExpression.this))
            {
                node.parent().removeChild(node);
            }
