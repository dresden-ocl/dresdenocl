...
public final class ADivNumericExpression extends PNumericExpression
{
    private PNumericExpression _op1_;
    private PNumericExpression _op2_;

    public ADivNumericExpression()
    {
    }
    ...
    public Object clone()
    {
        return new ADivNumericExpression(
    ...
    {
        ((Analysis) sw).caseADivNumericExpression(this);
    }
