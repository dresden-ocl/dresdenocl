...
public final class AValueNumericExpression extends PNumericExpression
{
    private PUnaryExpression _unaryExpression_;

    public AValueNumericExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AValueNumericExpression(
            (PUnaryExpression) cloneNode(_unaryExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAValueNumericExpression(this);
    }
