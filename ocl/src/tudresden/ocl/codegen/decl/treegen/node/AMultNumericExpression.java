...
public final class AMultNumericExpression extends PNumericExpression
{
    private PNumericExpression _op1_;
    private PNumericExpression _op2_;

    public AMultNumericExpression()
    {
    }
    ...
    public Object clone()
    {
        return new AMultNumericExpression(
    ...
    {
        ((Analysis) sw).caseAMultNumericExpression(this);
    }
