...
/**
 * This class represents a OclAny that was directly given in the
 * ocl-constraint (we do not need to compute it at all).
 */
public class ExpBase extends Exp {
  OclRoot oclRoot;

  public ExpBase(Object o) {
    this.oclRoot = Ocl.getFor(o);
  ...
  public String toString() {
    return super.toString() + ": " + oclRoot.toString();
  }
}