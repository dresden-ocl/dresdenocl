...
/**
 * A class that provides the main tab to parameterize launch configurations. Set
 * the overrideLaunchConfigurationMainTab option to false to customize this
 * class.
 */
public class OclLaunchConfigurationMainTab extends
	...
	public void initializeFrom(
		...
		try {
			...
			org.dresdenocl.language.ocl.resource.ocl.mopp.OclPlugin.logError(
					"Can't initialize launch configuration tab.", e);
		}
	}
	...
	public void performApply(
		...
		configuration.setAttribute(OclDebugUIPlugin.OCL_URI, uriText.getText());
	}
	...
	public org.eclipse.swt.graphics.Image getImage() {
		...
		// return
		// org.dresdenocl.language.ocl.resource.ocl.ui.OclImageProvider.INSTANCE.getImage("icons/launch_tab_main_icon.gif");
		return null;
	}
