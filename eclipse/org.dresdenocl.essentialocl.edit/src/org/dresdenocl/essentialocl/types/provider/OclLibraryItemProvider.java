...
public class OclLibraryItemProvider extends ItemProviderAdapter implements
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				TypesPackageImpl.Literals.OCL_LIBRARY__OCL_STRING,
				PivotModelFactory.eINSTANCE.createPrimitiveType()));

		newChildDescriptors.add(createChildParameter(
				TypesPackageImpl.Literals.OCL_LIBRARY__OCL_INTEGER,
				PivotModelFactory.eINSTANCE.createPrimitiveType()));

		newChildDescriptors.add(createChildParameter(
				TypesPackageImpl.Literals.OCL_LIBRARY__OCL_REAL,
				PivotModelFactory.eINSTANCE.createPrimitiveType()));

		newChildDescriptors.add(createChildParameter(
				TypesPackageImpl.Literals.OCL_LIBRARY__OCL_INVALID,
		...
		newChildDescriptors.add(createChildParameter(
				TypesPackageImpl.Literals.OCL_LIBRARY__OCL_SEQUENCE,
