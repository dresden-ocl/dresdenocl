...
public privileged aspect LoyaltyProgram_InvAspect_knownServiceLevel {
    ...
    declare parents: org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyProgram implements org.dresdenocl.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyProgram.checkInvariants() {
