...
public privileged aspect Service_PostAspect_upgradePointsEarned {
    ...
    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.examples.royalsandloyals.ocl22javacode.Service#upgradePointsEarned(Integer amount)}.</p>
     */
    protected pointcut upgradePointsEarnedCaller(org.dresdenocl.examples.royalsandloyals.ocl22javacode.Service aClass, Integer amount):
    	call(* org.dresdenocl.examples.royalsandloyals.ocl22javacode.Service.upgradePointsEarned(Integer))
     ...
     */
    void around(org.dresdenocl.examples.royalsandloyals.ocl22javacode.Service aClass, Integer amount): upgradePointsEarnedCaller(aClass, amount) {
