...
public privileged aspect Transaction_PreAspect_getProgram {
     ...
     */
    before(org.dresdenocl.examples.royalsandloyals.ocl22javacode.Transaction aClass): getProgramCaller(aClass) {
        ...
        if (!aClass.getClass().getCanonicalName().equals(org.dresdenocl.examples.royalsandloyals.ocl22javacode.Transaction.class.getCanonicalName())) {
