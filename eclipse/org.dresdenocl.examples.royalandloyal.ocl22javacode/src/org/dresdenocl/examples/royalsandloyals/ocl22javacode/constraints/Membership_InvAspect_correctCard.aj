...
public privileged aspect Membership_InvAspect_correctCard {
    ...
    declare parents: org.dresdenocl.examples.royalsandloyals.ocl22javacode.Membership implements org.dresdenocl.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.examples.royalsandloyals.ocl22javacode.Membership.checkInvariants() {
    ...
    after(org.dresdenocl.examples.royalsandloyals.ocl22javacode.Membership aClass) : checkInvariantsCaller(aClass) {
        ...
        java.util.ArrayList<org.dresdenocl.examples.royalsandloyals.ocl22javacode.CustomerCard> result1;
        result1 = new java.util.ArrayList<org.dresdenocl.examples.royalsandloyals.ocl22javacode.CustomerCard>();

        /* Iterator Collect: Iterate through all elements and collect them. Elements which are collections are flattened. */
        for (org.dresdenocl.examples.royalsandloyals.ocl22javacode.Customer anElement1 : aClass.program.participants) {
            result1.addAll(anElement1.cards);
        }

        if (!org.dresdenocl.tools.codegen.ocl2java.types.util.OclCollections.includes((java.util.List<org.dresdenocl.examples.royalsandloyals.ocl22javacode.CustomerCard>) org.dresdenocl.tools.codegen.ocl2java.types.util.OclBags.flatten(result1), aClass.card)) {
