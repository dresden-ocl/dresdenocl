...
public privileged aspect LoyaltyAccount_DeriveAspect_totalPointsEarned {
    ...
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyAccount#totalPointsEarned}.</p>
     */
    protected pointcut totalPointsEarnedGetter(org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyAccount aClass) :
     ...
     */
    before(org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyAccount aClass): totalPointsEarnedGetter(aClass) {
        ...
        for (org.dresdenocl.examples.royalsandloyals.ocl22javacode.Transaction anElement1 : aClass.transactions) {
            if (anElement1.getClass().getCanonicalName().equals(org.dresdenocl.examples.royalsandloyals.ocl22javacode.Earning.class.getCanonicalName())) {
