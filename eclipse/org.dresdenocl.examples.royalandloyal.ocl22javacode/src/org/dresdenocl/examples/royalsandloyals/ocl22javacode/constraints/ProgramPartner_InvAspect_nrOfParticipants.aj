...
public privileged aspect ProgramPartner_InvAspect_nrOfParticipants {
    ...
    declare parents: org.dresdenocl.examples.royalsandloyals.ocl22javacode.ProgramPartner implements org.dresdenocl.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.examples.royalsandloyals.ocl22javacode.ProgramPartner.checkInvariants() {
    ...
    after(org.dresdenocl.examples.royalsandloyals.ocl22javacode.ProgramPartner aClass) : checkInvariantsCaller(aClass) {
        ...
        for (org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyProgram anElement1 : aClass.programs) {
