...
public privileged aspect LoyaltyAccount_PostAspect_isEmpty {
    ...
    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyAccount#isEmpty()}.</p>
     */
    protected pointcut isEmptyCaller(org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyAccount aClass):
    	call(* org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyAccount.isEmpty())
    	&& target(aClass);
     ...
     */
    Boolean around(org.dresdenocl.examples.royalsandloyals.ocl22javacode.LoyaltyAccount aClass): isEmptyCaller(aClass) {
