...
public privileged aspect Membership_DefAspect_getCurrentLevelName {
     ...
     */
    public String org.dresdenocl.examples.royalsandloyals.ocl22javacode.Membership.getCurrentLevelName() {
    	/* Self variable probably used within the definition. */
    	org.dresdenocl.examples.royalsandloyals.ocl22javacode.Membership aClass = this;
