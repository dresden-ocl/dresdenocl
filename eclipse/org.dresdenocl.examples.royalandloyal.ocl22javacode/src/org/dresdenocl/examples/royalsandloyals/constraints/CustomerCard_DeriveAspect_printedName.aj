...
public privileged aspect CustomerCard_DeriveAspect_printedName {
    ...
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.examples.royalsandloyals.CustomerCard#printedName}.</p>
     */
    protected pointcut printedNameGetter(org.dresdenocl.examples.royalsandloyals.CustomerCard aClass) :
     ...
     */
    before(org.dresdenocl.examples.royalsandloyals.CustomerCard aClass): printedNameGetter(aClass) {
