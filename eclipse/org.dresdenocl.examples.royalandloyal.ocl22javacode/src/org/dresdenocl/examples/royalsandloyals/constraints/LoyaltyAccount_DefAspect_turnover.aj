...
public privileged aspect LoyaltyAccount_DefAspect_turnover {
     ...
     */
    public Float org.dresdenocl.examples.royalsandloyals.LoyaltyAccount.turnover;

    /**
     * <p>Getter method for the attribute turnover.</p>
     */
    public Float org.dresdenocl.examples.royalsandloyals.LoyaltyAccount.getTurnover() {
        return this.turnover;    
    }
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.examples.royalsandloyals.LoyaltyAccount#turnover}.</p>
     */
    protected pointcut turnoverGetter(org.dresdenocl.examples.royalsandloyals.LoyaltyAccount aClass) :
     ...
     *       def: turnover : Real = transactions.amount->sum()</code></p>
     */
    before(org.dresdenocl.examples.royalsandloyals.LoyaltyAccount aClass): turnoverGetter(aClass) {
