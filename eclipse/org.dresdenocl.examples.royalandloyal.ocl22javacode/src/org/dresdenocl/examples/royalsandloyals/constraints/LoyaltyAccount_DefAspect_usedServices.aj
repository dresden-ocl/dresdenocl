...
public privileged aspect LoyaltyAccount_DefAspect_usedServices {
     ...
     */
    public java.util.Set<org.dresdenocl.examples.royalsandloyals.Service> org.dresdenocl.examples.royalsandloyals.LoyaltyAccount.usedServices;

    /**
     * <p>Getter method for the attribute usedServices.</p>
     */
    public java.util.Set<org.dresdenocl.examples.royalsandloyals.Service> org.dresdenocl.examples.royalsandloyals.LoyaltyAccount.getUsedServices() {
        return this.usedServices;    
    }
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.examples.royalsandloyals.LoyaltyAccount#usedServices}.</p>
     */
    protected pointcut usedServicesGetter(org.dresdenocl.examples.royalsandloyals.LoyaltyAccount aClass) :
     ...
     *       def: usedServices: Set(Service) = transactions.service->asSet()</code></p>
     */
    before(org.dresdenocl.examples.royalsandloyals.LoyaltyAccount aClass): usedServicesGetter(aClass) {
