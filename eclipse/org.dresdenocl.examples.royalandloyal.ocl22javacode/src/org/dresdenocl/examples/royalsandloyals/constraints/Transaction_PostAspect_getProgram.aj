...
public privileged aspect Transaction_PostAspect_getProgram {
    ...
    /**
     * <p>Adds all new instances of the class {@link org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyProgram} to the {@link java.util.Map}
     ...
     */
    after(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyProgram aClass) : execution(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyProgram.new(..)) && this(aClass) {
