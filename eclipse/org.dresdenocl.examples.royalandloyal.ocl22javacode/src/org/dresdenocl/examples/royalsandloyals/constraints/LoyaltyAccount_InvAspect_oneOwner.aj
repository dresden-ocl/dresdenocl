...
public privileged aspect LoyaltyAccount_InvAspect_oneOwner {
    ...
    declare parents: org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount implements tudresden.ocl20.pivot.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount.checkInvariants() {
    ...
    after(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.LoyaltyAccount aClass) : checkInvariantsCaller(aClass) {
        ...
        java.util.ArrayList<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard> result2;
        result2 = new java.util.ArrayList<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard>();
        ...
        /* Iterator Collect: Iterate through all elements and collect them. Elements which are collections are flattened. */
        for (org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.CustomerCard anElement2 : result2) {
