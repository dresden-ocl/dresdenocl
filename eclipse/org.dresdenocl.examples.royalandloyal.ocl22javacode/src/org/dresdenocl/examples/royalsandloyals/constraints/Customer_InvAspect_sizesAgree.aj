...
public privileged aspect Customer_InvAspect_sizesAgree {
    ...
    declare parents: org.dresdenocl.examples.royalsandloyals.Customer implements org.dresdenocl.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.examples.royalsandloyals.Customer.checkInvariants() {
        /* Remains empty. Is only filled with behavior by advice(s). */
    }
    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.examples.royalsandloyals.Customer#checkInvariants()}.</p>
     */
    protected pointcut checkInvariantsCaller(org.dresdenocl.examples.royalsandloyals.Customer aClass):
     ...
     */
    after(org.dresdenocl.examples.royalsandloyals.Customer aClass) : checkInvariantsCaller(aClass) {
        ...
        java.util.HashSet<org.dresdenocl.examples.royalsandloyals.CustomerCard> result1;
        result1 = new java.util.HashSet<org.dresdenocl.examples.royalsandloyals.CustomerCard>();

        /* Iterator Select: Select all elements which fulfill the condition. */
        for (org.dresdenocl.examples.royalsandloyals.CustomerCard anElement1 : aClass.cards) {
