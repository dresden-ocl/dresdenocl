...
public privileged aspect ProgramPartner_DefAspect_getBurningTransactions {
     ...
     */
    public java.util.Set<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Transaction> org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.ProgramPartner.getBurningTransactions() {
    	/* Self variable probably used within the definition. */
    	org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.ProgramPartner aClass = this;
    	
        java.util.ArrayList<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Transaction> result1;
        result1 = new java.util.ArrayList<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Transaction>();
        ...
        java.util.Set<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Transaction> result2;
        result2 = collection1;
        /* IterateExp: Iterate through all elements and perform an operation on them. */
        for (org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Transaction anElement2 : result1) {
            java.util.Set<org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Transaction> ifExpResult1;

            if (anElement2.getClass().getCanonicalName().equals(org.dresdenocl.tudresden.ocl20.pivot.examples.royalsandloyals.Burning.class.getCanonicalName())) {
