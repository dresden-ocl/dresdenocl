...
public privileged aspect LoyaltyProgram_PreAspect_enroll {
    ...
    /**
     * <p>Checks a precondition for the {@link LoyaltyProgram#enroll(, org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer c)} defined by the constraint
     * <code>context LoyaltyProgram::enroll(c: org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer) : Boolean
     *       pre: c.name <> ''</code></p>
     */
    before(org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyProgram aClass, org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer c): enrollCaller(aClass, c) {
