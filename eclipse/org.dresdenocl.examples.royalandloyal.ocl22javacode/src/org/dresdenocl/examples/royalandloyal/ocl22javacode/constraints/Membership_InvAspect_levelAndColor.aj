...
public privileged aspect Membership_InvAspect_levelAndColor {
    ...
    after(org.dresdenocl.examples.royalandloyal.ocl22javacode.Membership aClass) : checkInvariantsCaller(aClass) {
        ...
        if (!((!aClass.currentLevel.name.equals("Silver") || aClass.card.color.equals(org.dresdenocl.examples.royalandloyal.ocl22javacode.Color.silver)) && (!aClass.currentLevel.name.equals("Gold") || aClass.card.color.equals(org.dresdenocl.examples.royalandloyal.ocl22javacode.Color.gold)))) {
