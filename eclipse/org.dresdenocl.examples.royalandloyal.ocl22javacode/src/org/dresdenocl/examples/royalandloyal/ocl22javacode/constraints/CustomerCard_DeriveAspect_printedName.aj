...
public privileged aspect CustomerCard_DeriveAspect_printedName {
    ...
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard#printedName}.</p>
     */
    protected pointcut printedNameGetter(org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard aClass) :
     ...
     */
    before(org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard aClass): printedNameGetter(aClass) {
