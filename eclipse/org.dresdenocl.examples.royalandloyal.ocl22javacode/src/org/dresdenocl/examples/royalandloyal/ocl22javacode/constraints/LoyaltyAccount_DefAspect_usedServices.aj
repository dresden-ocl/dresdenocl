...
public privileged aspect LoyaltyAccount_DefAspect_usedServices {
     ...
     */
    public java.util.Set<org.dresdenocl.examples.royalandloyal.ocl22javacode.Service> org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount.usedServices;

    /**
     * <p>Getter method for the attribute usedServices.</p>
     */
    public java.util.Set<org.dresdenocl.examples.royalandloyal.ocl22javacode.Service> org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount.getUsedServices() {
        return this.usedServices;    
    }
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount#usedServices}.</p>
     */
    protected pointcut usedServicesGetter(org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount aClass) :
     ...
     *       def: usedServices: Set(Service) = transactions.service->asSet()</code></p>
     */
    before(org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount aClass): usedServicesGetter(aClass) {
