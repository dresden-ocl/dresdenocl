...
public privileged aspect Customer_PostAspect_birthdayHappens {
    ...
    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer#birthdayHappens()}.</p>
     */
    protected pointcut birthdayHappensCaller(org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer aClass):
    	call(* org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer.birthdayHappens())
    	&& target(aClass);
     ...
     */
    void around(org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer aClass): birthdayHappensCaller(aClass) {
