...
public privileged aspect CustomerCard_DefAspect_getTotalPoints {
    ...
    /**
     * <p>Defines the method getTotalPoints(org.dresdenocl.examples.royalandloyal.ocl22javacode.Date d) defined by the constraint
     * <code>context CustomerCard
     *       def: getTotalPoints(d: Date) : Integer = transactions->select(date.isAfter(d)).points->sum()</code></p>
     */
    public Integer org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard.getTotalPoints(org.dresdenocl.examples.royalandloyal.ocl22javacode.Date d) {
    	/* Self variable probably used within the definition. */
    	org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard aClass = this;
