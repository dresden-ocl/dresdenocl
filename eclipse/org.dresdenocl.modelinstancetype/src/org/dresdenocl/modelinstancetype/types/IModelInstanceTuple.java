 ...
 * the <code>IModelInstance</code>.
 * </p>
 * 
 * <p>
 * <strong>Tuple values cannot be part of the <code>IModelInstance</code> itself,
 * they can be only created by the standard library!</strong> Thus,
 * <code>IModelInstance</code>s should not implement this {@link Class}.
 * </p>
 * 
 * @author Claas Wilke
 */
