...
.
*/
package org.dresdenocl.ocl2parser.testcasegenerator.abstractsyntax;

import java.util.List;

public interface IComplexElement extends IModelExpression {
	public List<IModelExpression> getParameter();
	public void setParameter(List<IModelExpression> params);
