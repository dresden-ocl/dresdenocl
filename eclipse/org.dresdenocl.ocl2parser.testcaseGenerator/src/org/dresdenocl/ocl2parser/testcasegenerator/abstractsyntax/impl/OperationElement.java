...
public class OperationElement extends PivotmodelReferenceElement implements IOperationElement{

	public void accept(IVisitor visitor, IEnvironment env) throws BuildingASMException {
		visitor.visitOperationElement(this, env);
	}
	...
	public OperationElement(ITokenAS token) {
	...
	public void accept(IVisitorCodeGen visitor, StringBuffer buffer)
		...
		visitor.visitOperationElement(this, buffer);
