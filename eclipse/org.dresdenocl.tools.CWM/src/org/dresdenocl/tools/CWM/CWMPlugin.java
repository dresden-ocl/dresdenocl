 ...
 * $Id$
 */
package tudresden.ocl20.pivot.tools.CWM;
...
public class CWMPlugin extends Plugin {
	...
	/** The plug-in ID. */
	public static final String ID = "tudresden.CWM"; //$NON-NLS-1$

	/** The shared instance. */
	private static CWMPlugin plugin;

	/**
	 * <p>
	 * Creates a new {@link CWMPlugin}.
	 * </p>
	 */
	public CWMPlugin() {
