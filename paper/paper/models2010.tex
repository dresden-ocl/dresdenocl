...
\title{Improved Variability for OCL Constraint Interpretation}

% a short form should be given in case it is too long for the running head
\titlerunning{Improved Variability for OCL Constraint Interpretation}
...
\mails}
%
\authorrunning{Improved Variability for OCL Constraint Interpretation}
