...
\titlerunning{Improv\change{ed}{ing} Variability for OCL Constraint Interpretation}
...
\mails}
%
\authorrunning{Impro\change{ed}{ing} Variability for OCL Constraint Interpretation}
...
multiple modelling languages such as UML, EMF Ecore and various domain specific 
languages. \remove{OCL is only loosely coupled to these modelling languages, }It
...
\keywords{OCL, MDSD, Modelling, Constraint Interpretation.}
\end{abstract}
