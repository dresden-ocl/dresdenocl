...
\maketitle
\note{CW: Are the email addresses correct? Mine is.; Yes, is OK}
\begin{abstract}
  ...
  like \remove{the Meta Object Facility (MOF) or }Ecore. 
...
% keep model instances to introduce terminology 
 ...
 interfaces. We present how the implementation of such an architecture for DresdenOCL enables reuse of the same 
  OCL interpreter for various model realisation techniques \change{. Finally, our approach is evaluated in three
  case studies defining and interpreting OCL constraints on multiple models
  and model instances.}{and evaluate our approach in three case studies.}
  \note{CW: The abstract is too long. 150 words max. allowed!; Michael: with the removals, it should be OK}
