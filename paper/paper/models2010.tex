...
\begin{abstract}
  ...
  bound to a specific realisation technique like Java, Ecore, \note{CW: rephrase. But I don't know how.} or another
  specific model repository. In this paper we propose a generic adaptation
  architecture for OCL that hides models and \change{model}{their} instances 
