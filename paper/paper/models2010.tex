...
languages. 
\change{While OCL-annotated models are implemented in various implementation
languages, dynamic OCL semantics as required for OCL constraint 
...
\change{instantiations}{implementations} behind well-defined interfaces. 
We present an OCL interpreter that can interpret OCL constraints 
...
\change{instantiations}{implementations}.
