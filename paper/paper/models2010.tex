...
\usepackage{url}
\urldef{\mails}\path|{claas.wilke, michael.thiele, christian.wende}@inf.tu-dresden.de|
...
\mails}
%
\authorrunning{Extending Variability for OCL Interpretation}
...
\begin{abstract}
  ...
  a constraint language that is applied to various modelling
 ...
 interfaces. We present how the implementation of such an architecture for DresdenOCL enables reuse of the same 
  OCL interpreter for various technical spaces and evaluate our approach in three case studies.
