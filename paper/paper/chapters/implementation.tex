\section{Implementation}
	...
	adapt	various meta-models and models summarized as \emph{Model Adaptation}. Afterwards, the approach is \change{moved}{transposed/shifted} 
...
\subsection{Model Adaptation}
	...
	existing adapters are cached. Thus, \change{we avoid unnecessary and expensive adaptation}{unnecessary and expensive adaptation is avoided}, 
...
\subsection{Model Instance Adaptation}
	...
	behind \remove{standardised} interfaces. \change{This enables the
	...
	instantiations}{As an OCL interpreter only 
	accesses these interfaces, it can evaluate various model and model instance 
	combinations}. To provide means for model
	...
	Schizophrenia} \cite{assmann:isc}.\note{Claas: Reference Okay?} Due \add{to} the introduction of a common set of model
