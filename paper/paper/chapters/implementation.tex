\section{Implementation}
	...
	\note{could we provide metamodel of pivot and implementation type model}
...
\subsection{Model Adaptation}
	...
	\begin{figure}[tb]
			...
			\caption{\note{arrow names are very small, try to put parts of the lengthy caption to
	the text. Explain context there. inheritance relations are not explained,
	highlight adapter pattern, where is OCL from Fig.1 ?} The adaptation
