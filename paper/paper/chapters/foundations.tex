\section{The Generic Architecture of Dresden OCL2 for Eclipse}
	\note{First motivate variation, adapt section heading accordingly}
		...
		\begin{figure}[tb]
			...
			\change{implements}{instantiates} the constrained model. \note{Explain in
			text, to complicated for caption}{In this context, a model instance can be a
			set of runtime objects or a model modeled in a constrained meta-model!}}
	...
	\note{Is that important to understand the paper?}{Each language at layer
