...
rules for which \change{model instance
elements are Java objects}{Java objects represent a model instance}. At the layer M1 a technical space bridge can be observed, as the Java
...
\remove{The feature selection has to ensure that model
...
model instances (VP2) can vary. \add{Thus, various combinations of models and instances are possible,
as long as the
instances are located exactly one meta-layer below their model.}
