...
constraints. \change{OCLE does not allow for model or model instance adaptation.}
...
model~\cite{akehurst2003ocl}. \note{Claas: What does "`both"' mean here?} Both depend on a Java-based
...
infrastructures \add{using \emph{Java Generics}} \cite{damus:EclipseCon08}. 
