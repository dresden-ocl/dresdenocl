...
public privileged aspect Customer_InvAspect_sizesAgree {
    ...
    declare parents: org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer implements org.dresdenocl.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer.checkInvariants() {
        /* Remains empty. Is only filled with behavior by advice(s). */
    }
    /**
     * <p>Pointcut for all calls on {@link org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer#checkInvariants()}.</p>
     */
    protected pointcut checkInvariantsCaller(org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer aClass):
     ...
     */
    after(org.dresdenocl.examples.royalandloyal.ocl22javacode.Customer aClass) : checkInvariantsCaller(aClass) {
        ...
        java.util.HashSet<org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard> result1;
        result1 = new java.util.HashSet<org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard>();

        /* Iterator Select: Select all elements which fulfill the condition. */
        for (org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard anElement1 : aClass.cards) {
