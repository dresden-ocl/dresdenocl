...
public privileged aspect LoyaltyAccount_DeriveAspect_totalPointsEarned {
    ...
    /**
     * <p>Pointcut for all requests on {@link org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount#totalPointsEarned}.</p>
     */
    protected pointcut totalPointsEarnedGetter(org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount aClass) :
     ...
     */
    before(org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount aClass): totalPointsEarnedGetter(aClass) {
        java.util.HashSet<org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction> result2;
        result2 = new java.util.HashSet<org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction>();

        /* Iterator Select: Select all elements which fulfill the condition. */
        for (org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction anElement1 : aClass.transactions) {
            if (anElement1.getClass().getCanonicalName().equals(org.dresdenocl.examples.royalandloyal.ocl22javacode.Earning.class.getCanonicalName())) {
