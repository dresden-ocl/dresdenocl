...
public privileged aspect CustomerCard_InvAspect_checkDates {
    ...
    /**
     * <p>Pointcut for all changes of the attribute {@link org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard#validFrom}.</p>
     */
    protected pointcut validFromSetter(org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard aClass) :
        set(* org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard.validFrom) && target(aClass); 

    /**
     * <p>Pointcut for all changes of the attribute {@link org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard#validThru}.</p>
     */
    protected pointcut validThruSetter(org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard aClass) :
        set(* org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard.validThru) && target(aClass); 

    /**
     * <p>Pointcut to collect all attributeSetters.</p>
     */
    protected pointcut allSetters(org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard aClass) :
     ...
     */
    after(org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard aClass) : allCustomerCardConstructors(aClass) || allSetters(aClass) {
