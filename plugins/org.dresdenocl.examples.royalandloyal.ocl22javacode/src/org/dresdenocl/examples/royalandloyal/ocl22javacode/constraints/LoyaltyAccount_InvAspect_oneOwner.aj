...
public privileged aspect LoyaltyAccount_InvAspect_oneOwner {
    ...
    declare parents: org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount implements org.dresdenocl.tools.codegen.ocl2java.types.OclCheckable;

    public void org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount.checkInvariants() {
    ...
    after(org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyAccount aClass) : checkInvariantsCaller(aClass) {
        ...
        java.util.ArrayList<org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard> result2;
        result2 = new java.util.ArrayList<org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard>();
        ...
        /* Iterator Collect: Iterate through all elements and collect them. Elements which are collections are flattened. */
        for (org.dresdenocl.examples.royalandloyal.ocl22javacode.CustomerCard anElement2 : result2) {
