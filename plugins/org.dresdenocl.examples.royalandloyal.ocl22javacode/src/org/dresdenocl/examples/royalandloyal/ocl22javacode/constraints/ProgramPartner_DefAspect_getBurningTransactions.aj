...
public privileged aspect ProgramPartner_DefAspect_getBurningTransactions {
     ...
     */
    public java.util.Set<org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction> org.dresdenocl.examples.royalandloyal.ocl22javacode.ProgramPartner.getBurningTransactions() {
    	/* Self variable probably used within the definition. */
    	org.dresdenocl.examples.royalandloyal.ocl22javacode.ProgramPartner aClass = this;
    	
        java.util.ArrayList<org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction> result1;
        result1 = new java.util.ArrayList<org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction>();
        ...
        java.util.Set<org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction> result2;
        result2 = collection1;
        /* IterateExp: Iterate through all elements and perform an operation on them. */
        for (org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction anElement2 : result1) {
            java.util.Set<org.dresdenocl.examples.royalandloyal.ocl22javacode.Transaction> ifExpResult1;

            if (anElement2.getClass().getCanonicalName().equals(org.dresdenocl.examples.royalandloyal.ocl22javacode.Burning.class.getCanonicalName())) {
