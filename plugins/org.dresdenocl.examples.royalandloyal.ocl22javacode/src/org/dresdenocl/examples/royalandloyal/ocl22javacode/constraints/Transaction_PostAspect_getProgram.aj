...
public privileged aspect Transaction_PostAspect_getProgram {
    ...
    /**
     * <p>Adds all new instances of the class {@link org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyProgram} to the {@link java.util.Map}
     ...
     */
    after(org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyProgram aClass) : execution(org.dresdenocl.examples.royalandloyal.ocl22javacode.LoyaltyProgram.new(..)) && this(aClass) {
