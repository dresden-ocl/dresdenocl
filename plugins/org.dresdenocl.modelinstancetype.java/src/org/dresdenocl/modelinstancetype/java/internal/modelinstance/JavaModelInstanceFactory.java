...
public class JavaModelInstanceFactory extends BasisJavaModelInstanceFactory implements
   ...
   * (non-Javadoc)
   * 
   * @seeorg.dresdenocl.modelbus.modelinstance.types.impl.java. BasisJavaModelInstanceFactory
   ...
   * (non-Javadoc)
   * 
   * @seeorg.dresdenocl.modelbus.modelinstance.types.base. BasisJavaModelInstanceFactory
   * #createModelInstanceElement(java.lang.Object, org.dresdenocl.pivotmodel.Type)
   */
  @Override
  ...
  private IModelInstanceObject createJavaModelInstanceObject(Object object)
    ...
    result = new JavaModelInstanceObject(object, modelType, modelType, this);
      ...
      try {
        ...
        if (typeClass.isAssignableFrom(object.getClass())) {
          ...
          try {
            ...
            result = new JavaModelInstanceObject(object, typeClass, type, originalType, this);
          }

          catch (TypeNotFoundInModelException e) {
            /* Create an undefined instance object. */
            result = new JavaModelInstanceObject(null, typeClass, type, type, this);
          }
        }
