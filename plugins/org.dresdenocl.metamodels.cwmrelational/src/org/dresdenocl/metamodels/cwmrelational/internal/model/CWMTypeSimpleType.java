...
public class CWMTypeSimpleType extends CWMTypePrimitiveType<SQLSimpleType> implements Type {

	/**
	 * <p>
	 * Creates a new <code>CWMTypeSimpleType</code> instance.
	 * </p>
	 * 
	 * @param dslDataType
	 ...
	 * @generated
	 */
	public CWMTypeSimpleType(SQLSimpleType dslDataType,
			CWMAdapterFactory factory) {

		super(dslDataType,CWMTypeSimpleType.class,factory);
