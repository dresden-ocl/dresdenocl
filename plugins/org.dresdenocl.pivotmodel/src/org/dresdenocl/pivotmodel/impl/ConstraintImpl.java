 ...
 * <ul>
 *   <li>{@link org.dresdenocl.pivotmodel.impl.ConstraintImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.dresdenocl.pivotmodel.impl.ConstraintImpl#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link org.dresdenocl.pivotmodel.impl.ConstraintImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link org.dresdenocl.pivotmodel.impl.ConstraintImpl#getConstrainedElement <em>Constrained Element</em>}</li>
 *   <li>{@link org.dresdenocl.pivotmodel.impl.ConstraintImpl#getDefinedFeature <em>Defined Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	protected final List<ConstrainableElement> getConstrainedElementGen() {
		if (constrainedElement == null) {
			constrainedElement = new EObjectEList<ConstrainableElement>(
					...
					PivotModelPackage.CONSTRAINT__CONSTRAINED_ELEMENT);
		}
		...
		if (newDefinedFeature != definedFeature) {
			...
			if (definedFeature != null)
				msgs = ((InternalEObject) definedFeature).eInverseRemove(this,
						PivotModelPackage.FEATURE__SEMANTICS, Feature.class,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PivotModelPackage.CONSTRAINT__DEFINED_FEATURE,
					newDefinedFeature, newDefinedFeature));
	}
